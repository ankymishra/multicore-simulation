...
;===== Move 1KB data from M1 to DDR =====  
  ...
  DMA_SGR_DATA1 = 0x01000000 ; not used
  DMA_DSR_DATA1 = 0x01000010 ; not used
  DMA_CTL_DATA1 = 0x0040030C ; DMA_CTL_DATA, BSZ[31:12], DSEN[9], SGEN[8], Int2Ext[3], TRZ[1:0]
...
;===== Move 1KB data from DDR to M1 =====  
  ...
  DMA_SGR_DATA0 = 0x01000000 ; set SGC[31:20]:8, SGO[19:0]:14
  DMA_DSR_DATA0 = 0x01000010 ; set DSC[31:20]:8, DSO[19:0]:14
  DMA_CTL_DATA0 = 0x00400304 ; DMA_CTL_DATA,BSZ[31:12], DSEN[9], SGEN[8], Int2Ext[3], TRZ[1:0]
