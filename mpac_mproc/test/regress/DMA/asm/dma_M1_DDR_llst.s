...
;===== Move 1KB data from DDR to PAC0 M1 =====  
  ...
  DMA_ENA_ADDR1 = 0x2405C0C4 ;
  DMA_CLR_ADDR1 = 0x2405C0C8 ;
  DMA_LST_ADDR1 = 0x2405C0CC ;
                             
  DMA_SAR_DATA1 = 0x30000000 ; set DDR as start address 
  DMA_DAR_DATA1 = 0x24001000 ; set M1 as destination address 
  DMA_SGR_DATA1 = 0x00000000 ; not used
  DMA_DSR_DATA1 = 0x00000000 ; not used
  DMA_CTL_DATA1 = 0x00400804 ; DMA_CTL_DATA, BSZ[31:12],LLEN[11], DSEN[9], SGEN[8], Int2Ext[3], Burst[2], TRZ[1:0]
  DMA_ENA_DATA1 = 0x00000000 ; active dma
  DMA_CLR_DATA1 = 0x00000000 ; not used
  DMA_LST_DATA1 = 0x4C007000 ; update DAR, CTL, LLST
  ...
  { MOVI r0, DMA_LST_ADDR1 | NOP | NOP | NOP | NOP } 
  { MOVI r1, DMA_LST_DATA1 | NOP | NOP | NOP | NOP }
  { SW r1, r0, 0x0         | NOP | NOP | NOP | NOP }
  ...
  ;=== waiting dma finish transfer ===
  { MOVI r0, DMA_STATUS_ADDR | NOP | NOP | NOP | NOP }
  { MOVI r3, M1_BASE | MOVI A0, M1_BASE | NOP | NOP | NOP }
  { MOVI r10, 0x10 | NOP | NOP | NOP | NOP }  
DDR_M1:    
  { LW r4, r3, 0x7000  | NOP | NOP | NOP | NOP };| LW a1, a0, 0x7004 | NOP | LW A2, A0, 0x7014 | NOP }
  { LW r4, r3, 0x7004  | NOP | NOP | NOP | NOP };| LW a1, a0, 0x7014 | NOP | LW A2, A0, 0x7024 | NOP }
  { LW r4, r3, 0x7014  | NOP | NOP | NOP | NOP };| LW a1, a0, 0x7024 | NOP | LW A2, A0, 0x7034 | NOP }
  ;{ LW r1, r0, 0x0  | LW a1, a0, 0x7004 | NOP | LW A2, A0, 0x7014 | NOP }    
  ;{ LBCB r10,DDR_M1 | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }  
