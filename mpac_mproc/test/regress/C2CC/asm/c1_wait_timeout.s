...
;;Set TX_Message 0~3
{ movi r2, 0x11111111             | nop | nop | nop | nop }
{ movi r3, 0x22222222             | nop | nop | nop | nop }
{ movi r4, 0x33333333             | nop | nop | nop | nop }
{ movi r5, 0x44444444             | nop | nop | nop | nop }
...
;;Send TX_Message 4~7
{ movi r2, 0x00FF00FF             | nop | nop | nop | nop }
{ movi r3, 0x99999999             | nop | nop | nop | nop }
{ movi r4, 0xBBBBBBBB             | nop | nop | nop | nop }
{ movi r5, 0xDDDDDDDD             | nop | nop | nop | nop }
{ sw r2, r0, TX_Message0_offset   | nop | nop | nop | nop }
{ sw r3, r0, TX_Message1_offset   | nop | nop | nop | nop }
{ sw r4, r0, TX_Message2_offset   | nop | nop | nop | nop }
{ sw r5, r0, TX_Message3_offset   | nop | nop | nop | nop }
...
{ movi r4, 0xCCCCDDDD              | nop | nop | nop | nop }
