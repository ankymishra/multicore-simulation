...
{  MOVI.L R0, 0x0030  |  NOP  |  NOP  |  NOP  |  NOP  }
;Reg[R0] = 0x00000000
...
{  MOVI.H R0, 0x2410  |  NOP  |  NOP  |  NOP  |  NOP  }  ; 0x1E00
;Reg[R0] = 0x00000000
...
{  MOVI.L R0, 0x0050  |  NOP  |  NOP  |  NOP  |  NOP  }
;Reg[R0] = 0x00000020
...
;=============================================================
{  MOVI.L R0, 0x006C  |  NOP  |  NOP  |  NOP  |  NOP  }
;Reg[R0] = 0x0000003C
...
{  MOVI.H R0, 0x0810  |  NOP  |  NOP  |  NOP  |  NOP  } ; 0x1E00
;Reg[R0] = 0x00000020
