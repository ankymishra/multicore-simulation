...
;===== Move 2KB data from DDR to LDM =====  
  ...
  DMA_DAR_DATA0 = 0x25001067 ; set DMEM as destination address 
  DMA_SGR_DATA0 = 0x00000000 ; set SGC[31:20]:8, SGO[19:0]:14
  DMA_DSR_DATA0 = 0x02000020 ; set DSC[31:20]:8, DSO[19:0]:14
  DMA_CTL_DATA0 = 0x00100206 ; DMA_CTL_DATA,BSZ[31:20], DSEN[9], SGEN[8], Int2Ext[4], TRZ[1:0]
  DMA_ENA_DATA0 = 0x00000000 ; active dma
  DMA_CLR_DATA0 = 0x00000000 ; not used 
  DMA_PAD_DATA0 = 0x03003021 ; PAD_NUM2[31:24],PAD_NUM1[23:16],PAD_UNIT2[15:12],PAD_UNIT1[11:8],PAD_DIR2[5],PAD_DIR1[4],PAD_EN[0]
