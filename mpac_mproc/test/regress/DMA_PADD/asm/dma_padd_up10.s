...
;===== Move 2KB data from DDR to LDM =====  
  ...
  DMA_DAR_DATA0 = 0x24001005 ; set DMEM as destination address 
  DMA_SGR_DATA0 = 0x00300020 ; set SGC[31:20]:8, SGO[19:0]:14
  DMA_DSR_DATA0 = 0x00300020 ; set DSC[31:20]:8, DSO[19:0]:14
  DMA_CTL_DATA0 = 0x00018306 ; DMA_CTL_DATA,BSZ[31:20], DSEN[9], SGEN[8], Int2Ext[4], TRZ[1:0]
  DMA_ENA_DATA0 = 0x00000000 ; active dma
  DMA_CLR_DATA0 = 0x00000000 ; not used 
  DMA_PAD_DATA0 = 0x16001001 ;
