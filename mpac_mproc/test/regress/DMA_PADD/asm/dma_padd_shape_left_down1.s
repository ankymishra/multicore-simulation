...
;===== Move 2KB data from DDR to LDM =====  
  ...
  DMA_SHP_ADDR0 = 0x2405C094 ;  
  DMA_RES_ADDR0 = 0x2405C098 ;  
  
  DMA_SAR_DATA0 = 0x30000000 ; set DDR as start address 
  DMA_DAR_DATA0 = 0x2400108A ; set DMEM as destination address 
  DMA_SGR_DATA0 = 0x01F00020 ; set SGC[31:20]:8, SGO[19:0]:14
  DMA_DSR_DATA0 = 0x01F0002F ; set DSC[31:20]:8, DSO[19:0]:14
  DMA_CTL_DATA0 = 0x000F8336 ; DMA_CTL_DATA,BSZ[31:20], DSEN[9], SGEN[8], DSHEN[5], SSHEN[4], Int2Ext[3], Burst[2], TRZ[1:0]
  ...
  DMA_SHP_DATA0 = 0x1F081F08 ; SRC_X[31:24],SRC_Y[23:16],DST_X[15:8],DST_Y[7:0]
  DMA_RES_DATA0 = 0x0020002F ; SRC[31:16], DST[15:0]
