...
int main()
{
  ...
  /* raw data */
  A(0x25000000); W(0x10101010);

  A(0x25000004); W(0x0f0f0f10);

  A(0x25000008); W(0x0e0e0f0f);

  A(0x2500000c); W(0x0e0e0e0e);

  A(0x25000010); W(0x10101010);

  A(0x25000014); W(0x0f0f0f10);

  A(0x25000018); W(0x0e0e0f0f);

  A(0x2500001c); W(0x0e0e0e0e);

  A(0x25000020); W(0x10101010);

  A(0x25000024); W(0x0f0f0f10);

  A(0x25000028); W(0x0e0e0f0f);

  A(0x2500002c); W(0x0e0e0e0e);

  A(0x25000030); W(0x10101010);

  A(0x25000034); W(0x0f0f0f10);

  A(0x25000038); W(0x0e0e0f0f);

  A(0x2500003c); W(0x0e0e0e0e);

  A(0x25000040); W(0x10101010);

  A(0x25000044); W(0x0f0f0f10);

  A(0x25000048); W(0x0e0e0f0f);

  A(0x2500004c); W(0x0e0e0e0e);

  A(0x25000050); W(0x10101010);

  A(0x25000054); W(0x0f0f0f10);

  A(0x25000058); W(0x0e0e0f0f);

  A(0x2500005c); W(0x0e0e0e0e);

  A(0x25000060); W(0x10101010);

  A(0x25000064); W(0x0f0f0f10);

  A(0x25000068); W(0x0e0e0f0f);

  A(0x2500006c); W(0x0e0e0e0e);

  A(0x25000070); W(0x10101010);

  A(0x25000074); W(0x0f0f0f10);

  A(0x25000078); W(0x0e0e0f0f);

  A(0x2500007c); W(0x0e0e0e0e);

  A(0x25000080); W(0x10101010);

  A(0x25000084); W(0x0f0f0f10);

  A(0x25000088); W(0x0e0e0f0f);

  A(0x2500008c); W(0x0e0e0e0e);

  A(0x25000090); W(0x10101010);

  A(0x25000094); W(0x0f0f0f10);

  A(0x25000098); W(0x0e0e0f0f);

  A(0x2500009c); W(0x0e0e0e0e);

  A(0x250000a0); W(0x10101010);

  A(0x250000a4); W(0x0f0f0f10);

  A(0x250000a8); W(0x0e0e0f0f);

  A(0x250000ac); W(0x0e0e0e0e);

  A(0x250000b0); W(0x10101010);

  A(0x250000b4); W(0x0f0f0f10);

  A(0x250000b8); W(0x0e0e0f0f);

  A(0x250000bc); W(0x0e0e0e0e);

  A(0x250000c0); W(0x10101010);

  A(0x250000c4); W(0x0f0f0f10);

  A(0x250000c8); W(0x0e0e0f0f);

  A(0x250000cc); W(0x0e0e0e0e);

  A(0x250000d0); W(0x10101010);

  A(0x250000d4); W(0x0f0f0f10);

  A(0x250000d8); W(0x0e0e0f0f);

  A(0x250000dc); W(0x0e0e0e0e);

  A(0x250000e0); W(0x10101010);

  A(0x250000e4); W(0x0f0f0f10);

  A(0x250000e8); W(0x0e0e0f0f);

  A(0x250000ec); W(0x0e0e0e0e);

  A(0x250000f0); W(0x10101010);

  A(0x250000f4); W(0x0f0f0f10);

  A(0x250000f8); W(0x0e0e0f0f);

  A(0x250000fc); W(0x0e0e0e0e);
  ...
  /* Result */
  A(0x25000190); R(0x00030000,NO_Mask);
  /* Residual */
