...
int main()
{
  ...
  /* Raw Cb */
  A(0x25000000); W(0x0a0a0a3c);

  A(0x25000004); W(0x0a0a0a0a);

  A(0x25000008); W(0x0a0a0a3c);

  A(0x2500000c); W(0x0a0a0a0a);

  A(0x25000010); W(0x0a0a0a3c);

  A(0x25000014); W(0x0a0a0a0a);

  A(0x25000018); W(0x0a0a0a3c);

  A(0x2500001c); W(0x0a0a0a0a);

  A(0x25000020); W(0x0a0a0a3c);

  A(0x25000024); W(0x0a0a0a0a);

  A(0x25000028); W(0x0a0a0a3c);

  A(0x2500002c); W(0x0a0a0a0a);

  A(0x25000030); W(0x0a0a0a3c);

  A(0x25000034); W(0x0a0a0a0a);

  A(0x25000038); W(0x0a0a0a3c);

  A(0x2500003c); W(0x0a0a0a0a);

  /* Raw Cr */
  A(0x25000040); W(0x0a0a0a3c);

  A(0x25000044); W(0x0a0a0a0a);

  A(0x25000048); W(0x0a0a0a3c);

  A(0x2500004c); W(0x0a0a0a0a);

  A(0x25000050); W(0x0a0a0a3c);

  A(0x25000054); W(0x0a0a0a0a);

  A(0x25000058); W(0x0a0a0a3c);

  A(0x2500005c); W(0x0a0a0a0a);

  A(0x25000060); W(0x0a0a0a3c);

  A(0x25000064); W(0x0a0a0a0a);

  A(0x25000068); W(0x0a0a0a3c);

  A(0x2500006c); W(0x0a0a0a0a);

  A(0x25000070); W(0x0a0a0a3c);

  A(0x25000074); W(0x0a0a0a0a);

  A(0x25000078); W(0x0a0a0a3c);
  ...
  /* Result */
  A(0x25000190); R(0x00000002,NO_Mask);
  /* Residual Cb */
