...
;{  MOVI.H R4, 0x0014  |  NOP  |  NOP  |  NOP  |  NOP  }
;{  SW R4, R3, 4+      |  NOP  |  NOP  |  NOP  |  NOP  }
;;EN
;{  MOVI.L R4, 0x0000  |  NOP  |  NOP  |  NOP  |  NOP  }
;{  MOVI.H R4, 0x0000  |  NOP  |  NOP  |  NOP  |  NOP  }
...
;;CTL
;{  MOVI.L R4, 0x0002  |  NOP  |  NOP  |  NOP  |  NOP  }
;{  MOVI.H R4, 0x002F  |  NOP  |  NOP  |  NOP  |  NOP  }
;{  SW R4, R3, 4+      |  NOP  |  NOP  |  NOP  |  NOP  }
;;EN
;{  MOVI.L R4, 0x0000  |  NOP  |  NOP  |  NOP  |  NOP  }
;{  MOVI.H R4, 0x0000  |  NOP  |  NOP  |  NOP  |  NOP  }
...
; start function(EC)
	...
	{	MOVI.L R1, 0x0005 			|				NOP				|				NOP				|				NOP				|				NOP				}	
	{ COPY SR5, R1					 	|				NOP				|				NOP				|				NOP				|				NOP				}

; test if busy
	{	TEST P3, P4, 0xFFFF, 0x2005 	|				NOP				|				NOP				|				NOP				|				NOP				}

; wait for done (1024 cycles)
	{	MOVI.H R2, 0x2000 			|				NOP				|				NOP				|				NOP				|				NOP				}	
	{	MOVI.L R2, 0x0000 			|				NOP				|				NOP				|				NOP				|				NOP				}	
	{ COPY SR5, R2					 	|				NOP				|				NOP				|				NOP				|				NOP				}
	
	{	MOVI R3, 1024 					|				NOP				|				NOP				|				NOP				|				NOP				}	
	{	WAIT R3, 0xFFFF, 0x0005 |				NOP				|				NOP				|				NOP				|				NOP				}
  {  NOP                     |  NOP  |  NOP  |  NOP  |  NOP  }
  {  NOP                     |  NOP  |  NOP  |  NOP  |  NOP  }
  {  NOP                     |  NOP  |  NOP  |  NOP  |  NOP  }
  {  NOP                     |  NOP  |  NOP  |  NOP  |  NOP  }
