...
M1_1D_To_1D_result    = 0x24000000

DMA_M2_SR      = 0x25820054
 

Initial_Data:
{ movi r0, 0x2000             | movi a0, PACDSP0_M2_BaseAddr | movi d0, 0x00000001 | nop                          | nop          }
_LOOP:                                                                                                                             
...
;;CH0 Test 1D -> 1D Transfer

;;Scalar Set CH0 DMA, 
{ movi r0, PACDSP0_M2_DMA_Base | NOP  |NOP | NOP | nop          }
;;SAR
{ movi r1, PACDSP0_M2_BaseAddr| NOP | NOP  | NOP | nop          }
{ nop                          | NOP            | nop                 | NOP          | nop          }
{ sw r1, r0, DMA_SAR0_offset   | NOP   | NOP | NOP | nop          }
;;DAR
{ movi r2, M1_1D_To_1D_result  | NOP   | NOP | NOP  | nop          }
...
;;CTL
{ movi r5, 0x0800000C          | NOP           | NOP | NOP         | nop          }
