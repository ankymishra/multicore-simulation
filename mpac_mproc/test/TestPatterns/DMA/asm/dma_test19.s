...
{  MOVI.H R4, 0x0001  |  MOVI.H A1, 0x0001  |  NOP  |  MOVI.H A4, 0x1B80  |  NOP  }
...
;************************************************************** Parameter1
{  MOVI.L R3, 0xC130  |  MOVI.L A0, 0x6000  |  NOP  |  MOVI.L A3, 0x7000  |  NOP  }
...
{  MOVI.H R4, 0x0001  |  MOVI.H A1, 0x1D00  |  NOP  |  MOVI.H A4, 0x0001  |  NOP  }
{  SW R4, R3, 16      |  SW A1, A0, 16      |  NOP  |  MOVI.L A5, 0x7200  |  NOP  }
;LLST                                       
{  MOVI.L R4, 0x7000  |  NOP                |  NOP  |  MOVI.H A5, 0x1F00  |  NOP  }
{  MOVI.H R4, 0x1F80  |  NOP                |  NOP  |  DSW A4, A5, A3, 16 |  NOP  }
...
{  MOVI.L R3, 0xC130  |  MOVI.L A0, 0x8030  |  NOP  |  NOP  |  NOP  }
...
{  NOP                |  MOVI.H A1, 0x2400  |  NOP  |  NOP  |  NOP  }
