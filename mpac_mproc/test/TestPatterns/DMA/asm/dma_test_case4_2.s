;;---------------------- To Verify ---------------------------
;;DMA Transfer : DMA transfer 2D->2D, 2D->1D, 1D->1D Data from M2 to M1
...
M1_2D_To_2D_result    = 0x24000000 
M1_2D_To_1D_result    = 0x24001000
M1_1D_To_1D_result    = 0x24002000

DMA_M1_SR      = 0x25820054
...
{ nop                          | addi d0, d0, 0x0004           | nop                 | addi d0, d0, 0x0010          | nop          }
...
;;SGR
{ movi r3, 0x01000010          | movi d1, 0x02000020           | nop                 | movi d1, 0x00000000          | nop          }
{ sw r3, r0, DMA_SGR0_offset   | sw d1, a0, DMA_SGR1_offset    | nop                 | sw d1, a0, DMA_SGR2_offset   | nop          }
;;DSR
{ movi r4, 0x02000020          | movi d2, 0x00000000           | nop                 | movi d2, 0x00000000          | nop          }
{ sw r4, r0, DMA_DSR0_offset   | sw d2, a0, DMA_DSR1_offset    | nop                 | sw d2, a0, DMA_DSR2_offset   | nop          }
;;CTL
{ movi r5, 0x0004030C          | movi d3, 0x0008010C           | nop                 | movi d3, 0x0004000C          | nop          }
...
{  NOP                     |  NOP  |  NOP  |  NOP  |  NOP  }
{  NOP                     |  NOP  |  NOP  |  NOP  |  NOP  }
{  SEQI R7, P1, P2, R6, 0x00000222  |  NOP  |  NOP  |  NOP  |  NOP  }
