...
;************************************************************** Parameter0
{  MOVI.L R3, 0x00B0  |  MOVI.L A0, 0x0130  |  NOP  |  MOVI.L A3, 0x3000  |  NOP  }
...
;LLST
{  MOVI.L R4, 0x3000  |  MOVI.L A1, 0x5000  |  NOP  |  MOVI.H A4, 0x1980  |  NOP  }
{  MOVI.H R4, 0x1B80  |  MOVI.H A1, 0x1980  |  NOP  |  SW A4, A3, 16      |  NOP  }
...
{  NOP                |  MOVI.H A2, 0x0000  |  NOP  |  MOVI.H A5, 0x1880  |  NOP  }
;LLST
{  MOVI.L R4, 0x3030  |  DSW A1, A2, A0, 8  |  NOP  |  DSW A4, A5, A3, 8  |  NOP  }
{  MOVI.H R4, 0x1D00  |  NOP                |  NOP  |  NOP                |  NOP  }
...
{  MOVI.H R4, 0x1980  |  MOVI.H A1, 0x0000  |  NOP  |  MOVI.H A4, 0x0000  |  NOP  }
{  SW R4, R3, 8       |  MOVI.L A2, 0x5030  |  NOP  |  SW A4, A3, 8       |  NOP  }
{  NOP                |  MOVI.H A2, 0x1900  |  NOP  |  NOP                |  NOP  }
;DSR                                                                      
...
{  NOP                     |  NOP  |  NOP  |  NOP  |  NOP  }
{  NOP                     |  NOP  |  NOP  |  NOP  |  NOP  }
{  SEQI R7, P1, P2, R6, 0x00002020  |  NOP  |  NOP  |  NOP  |  NOP  }
