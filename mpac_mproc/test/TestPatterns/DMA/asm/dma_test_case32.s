;;---------------------- To Verify ---------------------------
;;DMA Transfer : DMA transfer 2D->2D, 2D->1D, 1D->1D Data from M1 to M2
...
M1_2D_To_1D_result    = 0x25008000
M1_1D_To_1D_result    = 0x25010000

DMA_M1_SR      = 0x2405C054
 

Initial_Data:
{ movi r0, 0x2000             | movi a0, PACDSP0_LDM_BaseAddr | movi d0, 0x00000001 | nop                          | nop          }
_LOOP:                                                                                                                             
...
;;SAR
{ movi r1, PACDSP0_LDM_BaseAddr| movi d0, PACDSP0_LDM_BaseAddr | nop                 | movi d0, PACDSP0_LDM_BaseAddr| nop          }
{ nop                          | NOP           | nop                 | NOP          | nop          }
...
;;CTL
{ movi r5, 0x0800000C          | movi d3, 0x0800000C           | nop                 | movi d3, 0x0800000C          | nop          }
