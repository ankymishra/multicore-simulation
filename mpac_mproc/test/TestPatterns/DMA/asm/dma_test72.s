...
;************************************************************** Parameter0
{  MOVI.L R3, 0x00B0          |  MOVI.L A0, 0x00F0          |  NOP  |  MOVI.L A3, 0x3004  |  NOP  }
...
;DAR                                                       ;DAR,CTL
{  MOVI.L R4, 0x0000          |  MOVI.L A1, 0x0020          |  NOP  |  MOVI.L A4, 0x0018  |  NOP  }
{  MOVI.H R4, DspDataMemAddr  |  MOVI.H A1, DspDataMemAddr  |  NOP  |  MOVI.H A4, DspDataMemAddr  |  NOP  }
{  SW R4, R3, 4               |  SW A1, A0, 4               |  NOP  |  MOVI.L A5, 0x3004  |  NOP  }
;SGR                                                
{  MOVI.L R4, 0x0000          |  MOVI.L A1, 0x000A          |  NOP  |  MOVI.H A5, 0x0000  |  NOP  }
{  MOVI.H R4, 0x0000          |  MOVI.H A1, 0x0050          |  NOP  |  DSW A4, A5, A3, 4  |  NOP  }
{  SW R4, R3, 8               |  SW A1, A0, 8               |  NOP  |  NOP                |  NOP  }
;DSR                                                        
{  MOVI.L R4, 0x0011          |  MOVI.L A1, 0x0000          |  NOP  |  NOP                |  NOP  }
...
;LLST                                                       
{  MOVI.L R4, 0x3004          |  NOP                        |  NOP  |  NOP                |  NOP  }
...
{  NOP                     |  NOP  |  NOP  |  NOP  |  NOP  }
{  NOP                     |  NOP  |  NOP  |  NOP  |  NOP  }
{  SEQI R7, P1, P2, R6, 0x00000220  |  NOP  |  NOP  |  NOP  |  NOP  }
