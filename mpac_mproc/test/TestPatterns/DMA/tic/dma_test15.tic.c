...
int main()
{
  ...
  /* Result check */
    /* Parameter 0 */
      ...
      A(0x24000004); R(0x00000004,0x000000FF);
      
    /* Parameter 1 */
      A(0x24000010); R(0x13121110,0xFFFFFFFF);
      A(0x24000014); R(0x19161514,0xFFFFFFFF);
      A(0x24000018); R(0x1D1C1B1A,0xFFFFFFFF);
      A(0x2400001C); R(0x00221F1E,0x00FFFFFF);
    
    /* Parameter 2 */
      A(0x24000020); R(0x33323130,0xFFFFFFFF);
      A(0x24000024); R(0x3B363534,0xFFFFFFFF);
      A(0x24000028); R(0x3F3E3D3C,0xFFFFFFFF);
      A(0x2400002C); R(0x47464140,0xFFFFFFFF);
      A(0x24000030); R(0x4B4A4948,0xFFFFFFFF);

      
    /* Parameter 3 */
      A(0x24000040); R(0x54535251,0xFFFFFFFF);
      A(0x24000044); R(0x58575655,0xFFFFFFFF);
      A(0x24000048); R(0x5C5B5A59,0xFFFFFFFF);
      A(0x2400004C); R(0x63626160,0xFFFFFFFF);
      A(0x24000050); R(0x67666564,0xFFFFFFFF);
      A(0x24000054); R(0x6B6A6968,0xFFFFFFFF);
      A(0x24000058); R(0x7271706F,0xFFFFFFFF);
      A(0x2400005C); R(0x00007473,0x0000FFFF);
