...
{  NOP  |  NOP  |  (P14) SLT D2, P1, P2, D0, D1   |  NOP  |  NOP  }
;Reg[D2] = 0x0000_0001, Reg[P1] = 1, Reg[P2] = 0

{  NOP  |  NOP  |  (P15) SLT D2, P1, P2, D1, D0   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P1) SLTU D3, P3, P4, D0, D1   |  NOP  |  NOP  }
;Reg[D3] = 0x0000_0000, Reg[P3] = 0, Reg[P4] = 1

{  NOP  |  NOP  |  (P2) SLTU D3, P3, P4, D1, D0   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P4) SGT D4, P5, P6, D0, D1   |  NOP  |  NOP  }
;Reg[D4] = 0x0000_0000, Reg[P5] = 0, Reg[P6] = 1

{  NOP  |  NOP  |  (P3) SGT D4, P5, P6, D1, D0   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) SGTU D5, P7, P8, D0, D1   |  NOP  |  NOP  }
;Reg[D5] = 0x0000_0001, Reg[P7] = 1, Reg[P8] = 0

{  NOP  |  NOP  |  (P5) SGTU D5, P7, P8, D1, D0   |  NOP  |  NOP  }
;Not execute
...
{  NOP  |  NOP  |  (P7) SLT.L D2, P1, P2, D0, D1   |  NOP  |  NOP  }
;Reg[D2] = 0x0000_0000, Reg[P1] = 0, Reg[P2] = 1

{  NOP  |  NOP  |  (P8) SLT.L D2, P1, P2, D1, D0   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P2) SLTU.L D3, P3, P4, D0, D1   |  NOP  |  NOP  }
;Reg[D3] = 0x0000_0001, Reg[P3] = 1, Reg[P4] = 0

{  NOP  |  NOP  |  (P1) SLTU.L D3, P3, P4, D1, D0   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P3) SGT.L D4, P5, P6, D0, D1   |  NOP  |  NOP  }
;Reg[D4] = 0x0000_0001, Reg[P5] = 1, Reg[P6] = 0

{  NOP  |  NOP  |  (P4) SGT.L D4, P5, P6, D1, D0   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P5) SGTU.L D5, P7, P8, D0, D1   |  NOP  |  NOP  }
;Reg[D5] = 0x0000_0000, Reg[P7] = 0, Reg[P8] = 1

{  NOP  |  NOP  |  (P6) SGTU.L D5, P7, P8, D1, D0   |  NOP  |  NOP  }
;Not execute
...
{  NOP  |  NOP  |  (P8) SLT.H D2, P1, P2, D0, D1   |  NOP  |  NOP  }
;Reg[D2] = 0x0000_0001, Reg[P1] = 1, Reg[P2] = 0

{  NOP  |  NOP  |  (P7) SLT.H D2, P1, P2, D1, D0   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P1) SLTU.H D3, P3, P4, D0, D1   |  NOP  |  NOP  }
;Reg[D3] = 0x0000_0000, Reg[P3] = 0, Reg[P4] = 1

{  NOP  |  NOP  |  (P2) SLTU.H D3, P3, P4, D1, D0   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P4) SGT.H D4, P5, P6, D0, D1   |  NOP  |  NOP  }
;Reg[D4] = 0x0000_0000, Reg[P5] = 0, Reg[P6] = 1

{  NOP  |  NOP  |  (P3) SGT.H D4, P5, P6, D1, D0   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) SGTU.H D5, P7, P8, D0, D1   |  NOP  |  NOP  }
;Reg[D5] = 0x0000_0001, Reg[P7] = 1, Reg[P8] = 0

{  NOP  |  NOP  |  (P5) SGTU.H D5, P7, P8, D1, D0   |  NOP  |  NOP  }
;Not execute
;-------------------------------------------------------------- Store Result
{  NOP  |  SW D0, A0, 4+    |  NOP  |  NOP  |  NOP  }
...
{  NOP  |  NOP  |  MOVI.L D0, 0xFFFE  |  NOP  |  NOP  }
;Reg[D0] = 0x8000_FFFF

{  NOP  |  NOP  |  MOVI.H D0, 0xFFFF  |  NOP  |  NOP  }
;Reg[D0] = 0xFFFF_FFFE

{  NOP  |  NOP  |  (P7) SLTI D1, P1, P2, D0, 0xFFFF8000   |  NOP  |  NOP  }
;Reg[D1] = 0x0000_0000, Reg[P1] = 0, Reg[P2] = 1

{  NOP  |  NOP  |  (P8) SLTI D1, P1, P2, D0, 0x00000000   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P2) SLTIU D2, P3, P4, D0, 0xFFFF8000   |  NOP  |  NOP  }
;Reg[D2] = 0x0000_0000, Reg[P3] = 0, Reg[P4] = 1				

{  NOP  |  NOP  |  (P1) SLTIU D2, P3, P4, D0, 0xFFFFFFFF   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P4) SGTI D3, P5, P6, D0, 0xFFFF8000   |  NOP  |  NOP  }
;Reg[D3] = 0x0000_0001, Reg[P5] = 1, Reg[P6] = 0

{  NOP  |  NOP  |  (P3) SGTI D3, P5, P6, D0, 0x80000000   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P5) SGTIU D4, P7, P8, D0, 0xFFFF8000   |  NOP  |  NOP  }
;Reg[D4] = 0x0000_0001, Reg[P7] = 1, Reg[P8] = 0				

{  NOP  |  NOP  |  (P6) SGTIU D4, P7, P8, D0, 0xFFFFFFFF   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P7) SEQI D5, P9, P10, D0, 0xFFFFFFFE   |  NOP  |  NOP  }
;Reg[D5] = 0x0000_0001, Reg[P9] = 1, Reg[P10] = 0

{  NOP  |  NOP  |  (P8) SEQI D5, P9, P10, D0, 0xFFFFFF00   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P9) SEQIU D6, P11, P12, D0, 0xFFFF0000   |  NOP  |  NOP  }
;Reg[D6] = 0x0000_0000, Reg[P11] = 0, Reg[P12] = 1

{  NOP  |  NOP  |  (P10) SEQIU D6, P11, P12, D0, 0xFFFFFFFE   |  NOP  |  NOP  }
;Not execute
;-------------------------------------------------------------- Store Result 
{  NOP  |  SW D0, A0, 4+    |  NOP  |  NOP  |  NOP  }
...
{  NOP  |  NOP  |  (P12) SLTI D1, P1, P2, D0, 0x00FF8000   |  NOP  |  NOP  }
;Reg[D1] = 0x0000_0001, Reg[P1] = 1, Reg[P2] = 0

{  NOP  |  NOP  |  (P11) SLTI D1, P1, P2, D0, 0xFF000000   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P1) SLTIU D2, P3, P4, D0, 0x00FF8000   |  NOP  |  NOP  }
;Reg[D2] = 0x0000_0000, Reg[P3] = 0, Reg[P4] = 1				******** Sam

{  NOP  |  NOP  |  (P2) SLTIU D2, P3, P4, D0, 0xFFFFFFFF   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P4) SGTI D3, P5, P6, D0, 0x00FF8000   |  NOP  |  NOP  }
;Reg[D3] = 0x0000_0000, Reg[P5] = 0, Reg[P6] = 1

{  NOP  |  NOP  |  (P3) SGTI D3, P5, P6, D0, 0xFFFFFF00   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) SGTIU D4, P7, P8, D0, 0x00FF8000   |  NOP  |  NOP  }
;Reg[D4] = 0x0000_0001, Reg[P7] = 1, Reg[P8] = 0				******** Sam

{  NOP  |  NOP  |  (P5) SGTIU D4, P7, P8, D0, 0xFFFFFFFF   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P7) SEQI D5, P9, P10, D0, 0x00FFFFFE   |  NOP  |  NOP  }
;Reg[D5] = 0x0000_0000, Reg[P9] = 0, Reg[P10] = 1

{  NOP  |  NOP  |  (P8) SEQI D5, P9, P10, D0, 0xFFFFFFFE   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P10) SEQIU D6, P11, P12, D0, 0x00FF0000   |  NOP  |  NOP  }
;Reg[D6] = 0x0000_0000, Reg[P11] = 0, Reg[P12] = 1

{  NOP  |  NOP  |  (P9) SEQIU D6, P11, P12, D0, 0xFFFFFFFE   |  NOP  |  NOP  }
;Not execute
;-------------------------------------------------------------- Store Result 
{  NOP  |  SW D0, A0, 4+    |  NOP  |  NOP  |  NOP  }
...
{  NOP  |  NOP  |  (P12) SLTI D1, P1, P2, D0, 0x0000FF80   |  NOP  |  NOP  }
;Reg[D1] = 0x0000_0001, Reg[P1] = 1, Reg[P2] = 0

{  NOP  |  NOP  |  (P11) SLTI D1, P1, P2, D0, 0xFF000000   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P1) SLTIU D2, P3, P4, D0, 0x0000FF80   |  NOP  |  NOP  }
;Reg[D2] = 0x0000_0000, Reg[P3] = 0, Reg[P4] = 1				******** Sam

{  NOP  |  NOP  |  (P2) SLTIU D2, P3, P4, D0, 0xFFFFFFFF   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P4) SGTI D3, P5, P6, D0, 0x0000FF80   |  NOP  |  NOP  }
;Reg[D3] = 0x0000_0000, Reg[P5] = 0, Reg[P6] = 1

{  NOP  |  NOP  |  (P3) SGTI D3, P5, P6, D0, 0xFFFFFF00   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) SGTIU D4, P7, P8, D0, 0x0000FF80   |  NOP  |  NOP  }
;Reg[D4] = 0x0000_0001, Reg[P7] = 1, Reg[P8] = 0				******** Sam

{  NOP  |  NOP  |  (P5) SGTIU D4, P7, P8, D0, 0xFFFFFFFF   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P7) SEQI D5, P9, P10, D0, 0x0000FFFE   |  NOP  |  NOP  }
;Reg[D5] = 0x0000_0000, Reg[P9] = 0, Reg[P10] = 1

{  NOP  |  NOP  |  (P8) SEQI D5, P9, P10, D0, 0xFFFFFFFE   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P10) SEQIU D6, P11, P12, D0, 0x0000FFFE   |  NOP  |  NOP  }
;Reg[D6] = 0x0000_0000, Reg[P11] = 0, Reg[P12] = 1
...
{  NOP  |  NOP  |  (P12) SLTI D1, P1, P2, D0, 0x00000080   |  NOP  |  NOP  }
;Reg[D1] = 0x0000_0001, Reg[P1] = 1, Reg[P2] = 0

{  NOP  |  NOP  |  (P11) SLTI D1, P1, P2, D0, 0xFF000000   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P1) SLTIU D2, P3, P4, D0, 0x00000080   |  NOP  |  NOP  }
;Reg[D2] = 0x0000_0000, Reg[P3] = 0, Reg[P4] = 1				******** Sam

{  NOP  |  NOP  |  (P2) SLTIU D2, P3, P4, D0, 0xFFFFFFFF   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P4) SGTI D3, P5, P6, D0, 0x00000080   |  NOP  |  NOP  }
;Reg[D3] = 0x0000_0000, Reg[P5] = 0, Reg[P6] = 1

{  NOP  |  NOP  |  (P3) SGTI D3, P5, P6, D0, 0xFFFFFF00   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) SGTIU D4, P7, P8, D0, 0x00000080   |  NOP  |  NOP  }
;Reg[D4] = 0x0000_0001, Reg[P7] = 1, Reg[P8] = 0				******** Sam

{  NOP  |  NOP  |  (P5) SGTIU D4, P7, P8, D0, 0xFFFFFFFF   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P7) SEQI D5, P9, P10, D0, 0x000000FE   |  NOP  |  NOP  }
;Reg[D5] = 0x0000_0000, Reg[P9] = 0, Reg[P10] = 1

{  NOP  |  NOP  |  (P8) SEQI D5, P9, P10, D0, 0xFFFFFFFE   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P10) SEQIU D6, P11, P12, D0, 0x000000FE   |  NOP  |  NOP  }
;Reg[D6] = 0x0000_0000, Reg[P11] = 0, Reg[P12] = 1
...
{  NOP  |  NOP  |  (P12) SLTI D1, P1, P2, D0, 0x00000000   |  NOP  |  NOP  }
;Reg[D1] = 0x0000_0001, Reg[P1] = 1, Reg[P2] = 0

{  NOP  |  NOP  |  (P11) SLTI D1, P1, P2, D0, 0xFF000000   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P1) SLTIU D2, P3, P4, D0, 0x00000000   |  NOP  |  NOP  }
;Reg[D2] = 0x0000_0000, Reg[P3] = 0, Reg[P4] = 1				******** Sam

{  NOP  |  NOP  |  (P2) SLTIU D2, P3, P4, D0, 0xFFFFFFFF   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P4) SGTI D3, P5, P6, D0, 0x00000000   |  NOP  |  NOP  }
;Reg[D3] = 0x0000_0000, Reg[P5] = 0, Reg[P6] = 1

{  NOP  |  NOP  |  (P3) SGTI D3, P5, P6, D0, 0xFFFFFF00   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) SGTIU D4, P7, P8, D0, 0x00000000   |  NOP  |  NOP  }
;Reg[D4] = 0x0000_0001, Reg[P7] = 1, Reg[P8] = 0				******** Sam

{  NOP  |  NOP  |  (P5) SGTIU D4, P7, P8, D0, 0xFFFFFFFF   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P7) SEQI D5, P9, P10, D0, 0x00000000   |  NOP  |  NOP  }
;Reg[D5] = 0x0000_0000, Reg[P9] = 0, Reg[P10] = 1

{  NOP  |  NOP  |  (P8) SEQI D5, P9, P10, D0, 0xFFFFFFFE   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P10) SEQIU D6, P11, P12, D0, 0x00000000   |  NOP  |  NOP  }
;Reg[D6] = 0x0000_0000, Reg[P11] = 0, Reg[P12] = 1
...
{  NOP  |  NOP  |  MOVI.L D7, 0x7FFF  |  NOP  |  NOP  }
;Reg[D2] = 0x0000_7FFF

{  NOP  |  NOP  |  MOVI.H D7, 0xFFFF  |  NOP  |  NOP  }
;Reg[D2] = 0xFFFF_7FFF

{  NOP  |  NOP  |  (P12) SEQ D2, P1, P2, D0, D1   |  NOP  |  NOP  }
;Reg[D2] = 0x0000_0000, Reg[P1] = 0, Reg[P2] = 1

{  NOP  |  NOP  |  (P11) SEQ D2, P1, P2, D0, D0   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P2) SEQ.L D3, P3, P4, D0, D1   |  NOP  |  NOP  }
;Reg[D3] = 0x0000_0001, Reg[P3] = 1, Reg[P4] = 0

{  NOP  |  NOP  |  (P1) SEQ.L D3, P3, P4, D0, D7   |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P3) SEQ.H D4, P5, P6, D0, D1   |  NOP  |  NOP  }
;Reg[D4] = 0x0000_0000, Reg[P5] = 0, Reg[P6] = 1

{  NOP  |  NOP  |  (P4) SEQ.H D4, P5, P6, D1, D7   |  NOP  |  NOP  }
;Not execute
...
{  NOP  |  NOP  |  (P6) MIN D3, D0, D1  |  NOP  |  NOP  }
;Reg[D3] = 0x8000_7FFF

{  NOP  |  NOP  |  (P5) MIN D3, D2, D0  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) MINU D4, D0, D1  |  NOP  |  NOP  }
;Reg[D4] = 0x7FFF_8000

{  NOP  |  NOP  |  (P5) MINU D4, D1, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) MIN.D D5, D0, D1  |  NOP  |  NOP  }
;Reg[D5] = 0x8000_8000

{  NOP  |  NOP  |  (P5) MIN.D D5, D1, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) MINU.D D6, D0, D1  |  NOP  |  NOP  }
;Reg[D6] = 0x7FFF_7FFF

{  NOP  |  NOP  |  (P5) MINU.D D6, D0, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) MIN.Q D7, D0, D1  |  NOP  |  NOP  }
;Reg[D7] = 0x80FF_80FF

{  NOP  |  NOP  |  (P5) MIN.Q D7, D0, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) MINU.Q D8, D0, D1  |  NOP  |  NOP  }
;Reg[D8] = 0x7F00_7F00

{  NOP  |  NOP  |  (P5) MINU.Q D8, D0, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) DMIN D9, D0  |  NOP  |  NOP  }
;Reg[D9] = 0xFFFF_8000

{  NOP  |  NOP  |  (P5) DMIN D9, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) DMINU D10, D0  |  NOP  |  NOP  }
;Reg[D10] = 0x0000_7FFF

{  NOP  |  NOP  |  (P5) DMINU D10, D2  |  NOP  |  NOP  }
;Not execute
;-------------------------------------------------------------- Store Result 
{  NOP  |  SW D0, A0, 4+    |  NOP  |  NOP  |  NOP  }
...
{  NOP  |  NOP  |  (P6) MAX D3, D0, D1  |  NOP  |  NOP  }
;Reg[D3] = 0x7FFF_8000

{  NOP  |  NOP  |  (P5) MAX D3, D2, D1  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) MAXU D4, D0, D1  |  NOP  |  NOP  }
;Reg[D4] = 0x8000_7FFF

{  NOP  |  NOP  |  (P5) MAXU D4, D0, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) MAX.D D5, D0, D1  |  NOP  |  NOP  }
;Reg[D5] = 0x7FFF_7FFF

{  NOP  |  NOP  |  (P5) MAX.D D5, D0, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |   (P6) MAXU.D D6, D0, D1  |  NOP  |  NOP  }
;Reg[D6] = 0x8000_8000

{  NOP  |  NOP  |   (P5) MAXU.D D6, D0, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) MAX.Q D7, D0, D1  |  NOP  |  NOP  }
;Reg[D7] = 0x7F00_7F00

{  NOP  |  NOP  |  (P5) MAX.Q D7, D0, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) MAXU.Q D8, D0, D1  |  NOP  |  NOP  }
;Reg[D8] = 0x80FF_80FF

{  NOP  |  NOP  |  (P5) MAXU.Q D8, D0, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) DMAX D9, D0  |  NOP  |  NOP  }
;Reg[D9] = 0x0000_7FFF

{  NOP  |  NOP  |  (P5) DMAX D9, D2  |  NOP  |  NOP  }
;Not execute

{  NOP  |  NOP  |  (P6) DMAXU D10, D0  |  NOP  |  NOP  }
;Reg[D10] = 0x0000_8000

{  NOP  |  NOP  |  (P5) DMAXU D10, D2  |  NOP  |  NOP  }
;Not execute
;-------------------------------------------------------------- Store Result
{  NOP  |  SW D0, A0, 4+    |  NOP  |  NOP  |  NOP  }
...
{  NOP  |  NOP  |  MIN D2, D0, D1  |  NOP  |  NOP  }
;Reg[D2] = 0x8000_7FFF

{  NOP  |  NOP  |  MINU D3, D0, D1  |  NOP  |  NOP  }
;Reg[D3] = 0x7FFF_8000

{  NOP  |  NOP  |  MIN.D D4, D0, D1  |  NOP  |  NOP  }
;Reg[D4] = 0x8000_8000

{  NOP  |  NOP  |  MINU.D D5, D0, D1  |  NOP  |  NOP  }
;Reg[D5] = 0x7FFF_7FFF

{  NOP  |  NOP  |  MIN.Q D6, D0, D1  |  NOP  |  NOP  }
;Reg[D6] = 0x80FF_80FF

{  NOP  |  NOP  |  MINU.Q D7, D0, D1  |  NOP  |  NOP  }
;Reg[D7] = 0x7F00_7F00

{  NOP  |  NOP  |  DMIN D8, D0  |  NOP  |  NOP  }
;Reg[D8] = 0xFFFF_8000

{  NOP  |  NOP  |  DMINU D9, D0  |  NOP  |  NOP  }
;Reg[D9] = 0x0000_7FFF
;-------------------------------------------------------------- Store Result 
{  NOP  |  SW D0, A0, 4+    |  NOP  |  NOP  |  NOP  }
...
{  NOP  |  NOP  |  MAX D2, D0, D1  |  NOP  |  NOP  }
;Reg[D2] = 0x7FFF_8000

{  NOP  |  NOP  |  MAXU D3, D0, D1  |  NOP  |  NOP  }
;Reg[D3] = 0x8000_7FFF

{  NOP  |  NOP  |  MAX.D D4, D0, D1  |  NOP  |  NOP  }
;Reg[D4] = 0x7FFF_7FFF

{  NOP  |  NOP  |   MAXU.D D5, D0, D1  |  NOP  |  NOP  }
;Reg[D5] = 0x8000_8000

{  NOP  |  NOP  |  MAX.Q D6, D0, D1  |  NOP  |  NOP  }
;Reg[D6] = 0x7F00_7F00

{  NOP  |  NOP  |  MAXU.Q D7, D0, D1  |  NOP  |  NOP  }
;Reg[D7] = 0x80FF_80FF

{  NOP  |  NOP  |  DMAX D8, D0  |  NOP  |  NOP  }
;Reg[D8] = 0x0000_7FFF

{  NOP  |  NOP  |  DMAXU D9, D0  |  NOP  |  NOP  }
;Reg[D9] = 0x0000_8000
;-------------------------------------------------------------- Store Result
{  NOP  |  SW D0, A0, 4+    |  NOP  |  NOP  |  NOP  }
