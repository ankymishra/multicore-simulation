...
;===== Move 1KB data from LDM to DDR =====  
  ...
  DMA_DAR_DATA1 = 0x25008000 ; set DDR as destination address 
...
;======================== Define M2 REG =========================
  ...
  M2_DAR_DATA1 = 0x24004000 ; set DDR as destination address 
...
;======================== Move 1KB data from M2 to DDR =========================
  ...
  { NOP | MOVI a0, 0x25002000 | NOP | NOP | NOP }      
  { NOP | MOVI d0, 0x33334444 | NOP | NOP | NOP }      
chk_M2_sts:    
  { LW r1, r0, 0x0  | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP } 
  { NOP | NOP | NOP | NOP | NOP } 
  { SW r1, r6, 0x0 | SW d0, A0, 0x10 | NOP | NOP | NOP }
  { SW r1, r6, 0x4 | SW d0, A0, 0x14 | NOP | NOP | NOP }
  { SW r1, r6, 0x8 | SW d0, A0, 0x18 | NOP | NOP | NOP }
  { SW r1, r6, 0xC | SW d0, A0, 0x1C | NOP | NOP | NOP }    
...
;===== Move 1KB data from DDR to LDM =====  
  ...
  DMA_SAR_DATA0 = 0x25008000 ; set DDR as start address 
...
;======================== Define M2 REG =========================
  ...
  M2_SAR_DATA0 = 0x24004000 ; set M1 as start address 
