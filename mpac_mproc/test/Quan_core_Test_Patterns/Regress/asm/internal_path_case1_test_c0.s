...
INIT_DATA:
  ...
  {  NOP | NOP | NOP | NOP | NOP }
  {  MOVI R0, 0x03020100     | NOP | NOP | NOP | NOP }
  {  MOVI R1, M2_BASE1  | NOP | NOP | NOP | NOP }  
  {  MOVI R10, WORD_SIZE | NOP | NOP | NOP | NOP }
INIT_DATA1:
  {  SW R0, R1, 4+ | NOP | NOP | NOP | NOP }
  {  ADDI R0, R0, 0x04040404 | NOP | NOP | NOP | NOP }
...
;===== Move 1KB data from LDM to DDR =====  
  ...
  DMA_DAR_DATA1 = 0x25000000 ; set M2 memory as destination address 
...
;======================== Define M2 REG =========================
  ...
  M2_SAR_DATA1 = 0x25002000 ; set M1 as start address 
...
;setting c0 give c1 pointer  
  { MOVI r0, C0_START_C1_DMA | NOP | NOP | NOP | NOP } 
  { MOVI r1, 0x11223344 | NOP | NOP | NOP | NOP }
  { SW r1, r0, 0x0         | NOP | NOP | NOP | NOP }
...
;  {  MOVI R10, 0x30 | NOP | NOP | NOP | NOP }
;delay_loop1:
;  {  NOP | NOP | NOP | NOP | NOP }
;  {  LBCB R10, delay_loop1 | NOP | NOP | NOP | NOP }
;  {  NOP | NOP | NOP | NOP | NOP }
;  {  NOP | NOP | NOP | NOP | NOP }
;  {  NOP | NOP | NOP | NOP | NOP }
;  {  NOP | NOP | NOP | NOP | NOP }
...
;set M2 memory  
  ...
  { SW r7, r6, 0x4000         | NOP | NOP | NOP | NOP }  
;set DDR  
;  { MOVI r8, DDR_BASE | NOP | NOP | NOP | NOP }    
  { MOVI r8, M2_BASE | NOP | NOP | NOP | NOP }    
  { MOVI r9, 0x87654321 | NOP | NOP | NOP | NOP }      
;  { SW r9, r8, 0x4000         | NOP | NOP | NOP | NOP }  

;  {  MOVI R10, 0x10 | NOP | NOP | NOP | NOP }
;READ_M2:
;  {  LW r3, r6, 0x4000 | NOP | NOP | NOP | NOP }  
;  {  LBCB R10, READ_M2 | NOP | NOP | NOP | NOP }
;  {  NOP | NOP | NOP | NOP | NOP }
;  {  NOP | NOP | NOP | NOP | NOP }
;  {  NOP | NOP | NOP | NOP | NOP }
;  {  NOP | NOP | NOP | NOP | NOP }
...
;read M2 memory
  { LW r3, r6, 0x4000 | NOP | NOP | NOP | NOP }  
;read DDR  
  { LW r4, r8, 0x4000 | NOP | NOP | NOP | NOP }  
...
;;;;;  { NOP | NOP | NOP | NOP | NOP }
;;;;;  { NOP | NOP | NOP | NOP | NOP }
;;;;;  { SEQI r2, p1, p2, r3, 0x12345678 | NOP | NOP | NOP | NOP }     ; (DMA_STATUS == 0) ? 
;;;;;  { (p2) B chk_M2_write                 | NOP | NOP | NOP | NOP }
;;;;;  { NOP | NOP | NOP | NOP | NOP }
;;;;;  { NOP | NOP | NOP | NOP | NOP }  
;;;;;  { NOP | NOP | NOP | NOP | NOP }
;;;;;  { NOP | NOP | NOP | NOP | NOP }  
...
;;;;;  { NOP | NOP | NOP | NOP | NOP }
;;;;;  { NOP | NOP | NOP | NOP | NOP }
;;;;;  { SEQI r2, p1, p2, r4, 0x87654321 | NOP | NOP | NOP | NOP }     ; (DMA_STATUS == 0) ? 
;;;;;  { (p2) B chk_DDR_write                 | NOP | NOP | NOP | NOP }
;;;;;  { NOP | NOP | NOP | NOP | NOP }
;;;;;  { NOP | NOP | NOP | NOP | NOP }  
;;;;;  { NOP | NOP | NOP | NOP | NOP }
;;;;;  { NOP | NOP | NOP | NOP | NOP }  
;;;;;  { NOP | NOP | NOP | NOP | NOP }
  ...
  { NOP | NOP | NOP | NOP | NOP }  
;write M2 memory 
;;;  { SW r3, r6, 0x4004 | NOP | NOP | NOP | NOP }    
  { LW r3, r6, 0x4000 | NOP | NOP | NOP | NOP }      
;write DDR
;;;  { SW r4, r8, 0x4004 | NOP | NOP | NOP | NOP }  
  { LW r4, r8, 0x4000 | NOP | NOP | NOP | NOP }    
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
...
;set M1 memory  
  { MOVI r6, DMEM_BASE | NOP | NOP | NOP | NOP }    
  { MOVI r7, 0x11112222 | NOP | NOP | NOP | NOP }    
  { SW r7, r6, 0x2000 | NOP | NOP | NOP | NOP }  
  
DMEM2DDR:    
  { LW r1, r0, 0x0  | NOP | NOP | NOP | NOP }
;read M1 memory
  { LW r3, r6, 0x2000 | NOP | NOP | NOP | NOP }  
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
;write M1 memory  
  { SW r3, r6, 0x2004 | NOP | NOP | NOP | NOP }    
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
...
;===== Move 1KB data from DDR to LDM =====  
  ...
  DMA_SAR_DATA0 = 0x25000000 ; set M2 memory as start address 
...
;======================== Define M2 REG =========================
  ...
  M2_DAR_DATA0 = 0x25003000 ; set DDR as destination address 
...
;setting c0 give c1 pointer  
  { MOVI r0, C0_START_C1_DMA1 | NOP | NOP | NOP | NOP } 
  { MOVI r1, 0x55667788 | NOP | NOP | NOP | NOP }
  { SW r1, r0, 0x0         | NOP | NOP | NOP | NOP }
...
;read DDR
  ...
  { NOP | NOP | NOP | NOP | NOP }  
;write M2 memory
;;;;  { SW r3, r6, 0x4008 | NOP | NOP | NOP | NOP }    
  { LW r3, r6, 0x4000 | NOP | NOP | NOP | NOP }      
;write DDR
;;;;  { SW r4, r8, 0x4008 | NOP | NOP | NOP | NOP }  
  { LW r4, r8, 0x4000 | NOP | NOP | NOP | NOP }    
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
  { SEQI r2, p1, p2, r1, 0x22222222 | NOP | NOP | NOP | NOP }     ; (DMA_STATUS == 0) ? 
...
;set M1 memory
  { MOVI r6, DMEM_BASE | NOP | NOP | NOP | NOP }  
  { MOVI r7, 0x22221111 | NOP | NOP | NOP | NOP }    
  { SW r7, r6, 0x2000 | NOP | NOP | NOP | NOP }  
...
;read M1 memory
  ...
  { NOP | NOP | NOP | NOP | NOP }  
;write M1 memory
  { SW r3, r6, 0x2008 | NOP | NOP | NOP | NOP }      
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
  { SEQI r2, p1, p2, r1, 0x00002222 | NOP | NOP | NOP | NOP }     ; (DMA_STATUS == 0) ? 
