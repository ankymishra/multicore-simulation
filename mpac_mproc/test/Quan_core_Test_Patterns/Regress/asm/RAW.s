...
DMEM2DDR:    
  ...
  {  NOP | NOP | NOP | NOP | NOP }
  {  NOP | NOP | NOP | NOP | NOP } 
  {  MOVI R0, 0           | NOP | NOP | NOP | NOP }
  {  MOVI R1, DDR_BASE    | NOP | NOP | NOP | NOP }  
  {  MOVI R10, LOOP_COUNT | NOP | NOP | NOP | NOP }
LOOP_DATA:
  {  ADDI R0, R0, 0x1    | NOP | NOP | NOP | NOP }
  {  SW R0, R1, 0        | NOP | NOP | NOP | NOP }
  {  LW R2, R1, 0        | NOP | NOP | NOP | NOP }
  {  LBCB R10, LOOP_DATA | NOP | NOP | NOP | NOP }
  {  NOP | NOP | NOP | NOP | NOP }
  {  NOP | NOP | NOP | NOP | NOP }
  {  NOP | NOP | NOP | NOP | NOP }
  {  NOP | NOP | NOP | NOP | NOP }
