...
int main()
{
  ...
  /* Result check */
  /* Parameter 1 */
  A(0x24000000); R(0x03020100);
  A(0x24000004); R(0x07060504);
  A(0x24000008); R(0x00000008);
  A(0x24000010); R(0x000A0900);
  A(0x24000018); R(0x00141312);
  /* Parameter 2 */
  A(0x24000020); R(0x1B1A1918);
  A(0x24000024); R(0x0023221C);
