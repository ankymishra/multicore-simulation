...
int main()
{
  ...
  /* Result check */
  /* Parameter 0 */
  A(0x24000020); R(0x004B0000,0x00FF0000);
  A(0x24000024); R(0x004D004C,0x00FF00FF);
  A(0x24000028); R(0x00560055,0x00FF00FF);

  /* Parameter 1 */
  A(0x24000030); R(0x63626160,0xFFFFFFFF);
  A(0x24000034); R(0x69666564,0xFFFFFFFF);
  A(0x24000038); R(0x6C6B6A00,0xFFFFFF00);
  A(0x2400003C); R(0x00006E6D,0x0000FFFF);
