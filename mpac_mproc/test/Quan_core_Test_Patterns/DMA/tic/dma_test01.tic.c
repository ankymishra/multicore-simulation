...
int main()
{
  ...
  /* Parameter 2 */
  A(0x240000D0); W(0x00000000);
  A(0x240000D4); W(0x00000000);
  A(0x240000D8); W(0x00000000);
  A(0x240000DC); W(0x00000000);
  ...
  /* Parameter 2 */                     
  A(0x240000D0); R(0x03020100,0xFFFFFFFF);
  A(0x240000D4); R(0x00000004,0x000000FF);
  A(0x240000D8); R(0x07060500,0xFFFFFF00);
  A(0x240000DC); R(0x00000908,0x0000FFFF);
  A(0x240000E0); R(0x12110000,0xFFFF0000);
  A(0x240000E4); R(0x00151413,0x00FFFFFF);
  A(0x240000E8); R(0x16000000,0xFF000000);
  A(0x240000EC); R(0x1A191817,0xFFFFFFFF);
  A(0x240000F0); R(0x00000000,0x00000000);
  A(0x240000F4); R(0x25242322,0xFFFFFFFF);
  A(0x240000F8); R(0x00000026,0x000000FF);
  A(0x240000FC); R(0x29282700,0xFFFFFF00); 
  A(0x24000100); R(0x00002B2A,0x0000FFFF);
  A(0x24000104); R(0x34330000,0xFFFF0000);
  A(0x24000108); R(0x00000035,0x000000FF);
