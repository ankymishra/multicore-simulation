...
int main()
{
  ...
  A(0x24003000); W(0x00000000);
  A(0x24003004); W(0x00000000);
  A(0x24003008); W(0x00000000);
  A(0x2400300C); W(0x00000000);
    
  /* Parameter 3 */
  A(0x24004000); W(0x00000000);
  A(0x24004004); W(0x00000000);
  A(0x24004008); W(0x00000000);
  A(0x2400400C); W(0x00000000);
  ...
  /* Parameter 2 */
    A(0x24003000); R(0x07060504,0xFFFFFFFF);
    A(0x24003004); R(0x0F0E0D0C,0xFFFFFFFF);
    A(0x24003008); R(0x17161514,0xFFFFFFFF);
    A(0x2400300C); R(0x1F1E1D1C,0xFFFFFFFF);
    
  /* Parameter 3 */
  A(0x24004000); R(0x23222120,0xFFFFFFFF);
  A(0x24004004); R(0x28262524,0xFFFFFFFF);
  A(0x24004008); R(0x2C2B2A29,0xFFFFFFFF);
  A(0x2400400C); R(0x0000002D,0x000000FF);
