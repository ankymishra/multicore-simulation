...
int main()
{
  ...
  A(0x30070000); R(0x03020100,0xFFFFFF00);
  A(0x30070004); R(0x0b0a0504,0xFFFFFFFF);
  A(0x30070008); R(0x000e0d0c,0x00FFFFFF);
  A(0x30070010); R(0x14130000,0xFFFF0000);
  A(0x30070014); R(0x1c171615,0xFFFFFFFF);
  A(0x30070018); R(0x201f1e1d,0x00FFFFFF);
  A(0x30070020); R(0x25000000,0xFF000000);
  A(0x30070024); R(0x00282726,0x00FFFFFF);
