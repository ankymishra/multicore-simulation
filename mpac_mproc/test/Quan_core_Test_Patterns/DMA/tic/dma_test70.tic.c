...
int main()
{
  ...
  /* Result check */
  /* Parameter 1 */
  A(0x25000018); R(0x1B1A1900,0xFFFFFF00);
  A(0x2500001C); R(0x0000001C,0x000000FF);
  A(0x25000024); R(0x24232221,0xFFFFFFFF);
  A(0x25000028); R(0x00002500,0x0000FF00);
  A(0x2500002C); R(0x0000002A,0x000000FF);
  A(0x25000030); R(0x35340000,0xFFFF0000);
  A(0x25000034); R(0x00003B3A,0x0000FFFF);
  /* Parameter 3 */
  A(0x25000044); R(0x00004342,0x0000FFFF);
  A(0x2500004C); R(0x00004A44,0x0000FFFF);
  A(0x25000054); R(0x00004C4B,0x0000FFFF);
  A(0x25000064); R(0x00545300,0x00FFFF00);
  A(0x2500006C); R(0x00005D5C,0x0000FFFF);
  A(0x25000074); R(0x00006500,0x0000FF00);
  A(0x2500007C); R(0x006E0000,0x00FF0000);
  E();
