...
;===== Move 1KB data from M2 to DDR =====  
  ...
  DMA_SAR_ADDR1 = 0x258201B0 ;
  DMA_DAR_ADDR1 = 0x258201B4 ;
  DMA_SGR_ADDR1 = 0x258201B8 ;
  DMA_DSR_ADDR1 = 0x258201BC ;
  DMA_CTL_ADDR1 = 0x258201C0 ;
  DMA_ENA_ADDR1 = 0x258201C4 ;
  DMA_CLR_ADDR1 = 0x258201C8 ;
...
;===== Move 1KB data from DDR to M2 =====  
  ...
  DMA_SAR_ADDR0 = 0x25820170 ;
  DMA_DAR_ADDR0 = 0x25820174 ;
  DMA_SGR_ADDR0 = 0x25820178 ;
  DMA_DSR_ADDR0 = 0x2582017C ;
  DMA_CTL_ADDR0 = 0x25820180 ;
  DMA_ENA_ADDR0 = 0x25820184 ;
  DMA_CLR_ADDR0 = 0x25820188 ;
