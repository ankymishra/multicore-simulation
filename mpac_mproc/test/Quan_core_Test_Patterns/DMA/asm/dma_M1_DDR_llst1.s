...
;===== Move 1KB data from DDR to PAC0 M1 =====  
  ...
  DMA_ENA_DATA1 = 0x00000000 ; active dma
  DMA_CLR_DATA1 = 0x00000000 ; not used
  DMA_LST_DATA1 = 0x4C007004 ; update DAR, CTL, LLST
  ;DMA_LST_DATA1 = 0x01007500 ;
  ...
  ;=== waiting dma finish transfer ===
  { MOVI r0, DMA_STATUS_ADDR | NOP | NOP | NOP | NOP }
  { MOVI r3, M1_BASE | NOP | NOP | NOP | NOP }
DDR_M1:    
;  { LW r4, r3, 0x7000  | LW r5, r3, 0x7000 | NOP | NOP | NOP }
;  { LW r4, r3, 0x7004  | LW r5, r3, 0x7004 | NOP | NOP | NOP }
;  { LW r4, r3, 0x7014  | LW r5, r3, 0x7014 | NOP | NOP | NOP }    
  { LW r1, r0, 0x0  | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
  { SEQI r2, p1, p2, r1, 0x00002222 | NOP | NOP | NOP | NOP }     ; (DMA_STATUS == 0) ? 
