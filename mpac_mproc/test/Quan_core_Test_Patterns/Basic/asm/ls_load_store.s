...
{  BDT R0 |  BDR A3 |  NOP  |  NOP  |  NOP  }
{  NOP  |  MOVI.L A2, 0x0020    |  NOP  |  NOP  |  NOP  }  ;Reg[A2] = 0x0000_0020
{  NOP  |  MOVI.H A2, BASE_ADDR |  NOP  |  NOP  |  NOP  }  ;Reg[A2] = 0x0800_0020, modify by JH for 7056
{  NOP  |  ADD A2, A2, A3       |  NOP  |  NOP  |  NOP  }
...
{  BDT R0  |  BDR D0 |  NOP  |  NOP  |  NOP  }
{  NOP  |  MOVI.L A4, 0x008C    |  NOP  |  NOP  |  NOP  }  ;Reg[A4] = 0x0000_008C
{  NOP  |  MOVI.H A4, BASE_ADDR |  NOP  |  NOP  |  NOP  }  ;modify by JH for 7056
{  NOP  |  ADD A4, A4, D0       |  NOP  |  NOP  |  NOP  }
...
{  BDT R0  |  BDR D0 |  NOP  |  NOP  |  NOP  }
{  NOP  |  MOVI.L A4, 0x00A4    |  NOP  |  NOP  |  NOP  }  ;Reg[A4] = 0x0000_00A4
{  NOP  |  MOVI.H A4, BASE_ADDR |  NOP  |  NOP  |  NOP  }  ;Reg[A4] = 0x0800_00A4, modify by JH for 7056
{  NOP  |  ADD A4, A4, D0       |  NOP  |  NOP  |  NOP  }
...
{  BDT R0  |  BDR D0 |  NOP  |  NOP  |  NOP  }
{  NOP  |  MOVI.L A0, 0x0134    |  NOP  |  NOP  |  NOP  }   ;Reg[A0] = 0x1E00_0134
{  NOP  |  MOVI.H A0, BASE_ADDR |  NOP  |  NOP  |  NOP  }   ;Reg[A0] = 0x0800_0134, modify by JH for 7056
{  NOP  |  ADD A0, A0, D0       |  NOP  |  NOP  |  NOP  }
...
;**************************************************************¡iLinear:Offset¡j (D)LW
{  BDT R0  |  BDR D15 |  NOP  |  NOP  |  NOP  }
{  NOP  |  MOVI.L A0, 0x025C    |  NOP  |  NOP  |  NOP  }
{  NOP  |  MOVI.H A0, BASE_ADDR |  NOP  |  NOP  |  NOP  }  ; modify by JH for 7056
{  NOP  |  ADD A0, A0, D15      |  NOP  |  NOP  |  NOP  }
