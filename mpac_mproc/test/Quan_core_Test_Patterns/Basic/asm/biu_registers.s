...
;************************************************************** Set Start Address (R0)
{  COPY R4, SR15      |  NOP |  NOP  |  NOP  |  NOP  }
{  SLLI R4, R4, 20    |  NOP |  NOP  |  NOP  |  NOP  }
{  MOVI.L R0, 0x0000  |  NOP |  NOP  |  NOP  |  NOP  }
{  MOVI.H R0, BASE_ADDR |  NOP |  NOP  |  NOP  |  NOP  }
{  ADD R0, R0, R4     |  NOP |  NOP  |  NOP  |  NOP  }

;************************************************************** Program start address (CPSA)
{  MOVI.L R1, 0x0000   |  NOP |  NOP  |  NOP  |  NOP  }
{  MOVI.H R1, REG_ADDR |  NOP |  NOP  |  NOP  |  NOP  }  ; core reg. address 0x24050000
{  ADD R1, R1, R4      |  NOP |  NOP  |  NOP  |  NOP  }
...
{  MOVI.L R1, 0x4000   |  NOP |  NOP  |  NOP  |  NOP  }
{  MOVI.H R1, REG_ADDR |  NOP |  NOP  |  NOP  |  NOP  }  ; ICU reg. address 0x24054000
{  ADD R1, R1, R4      |  NOP |  NOP  |  NOP  |  NOP  }
...
;************************************************************** Base address (BAR)
{  MOVI.L R1, 0x8000   |  NOP |  NOP  |  NOP  |  NOP  }
{  MOVI.H R1, REG_ADDR |  NOP |  NOP  |  NOP  |  NOP  }  ; DMEM reg. address 0x24058000
{  ADD R1, R1, R4      |  NOP |  NOP  |  NOP  |  NOP  }
...
;Mem[0x1E00_003C] = 0x0000_0036

;************************************************************** CORE_ID
{  LW R3, R1, 0x30  |  NOP  |  NOP  |  NOP  |  NOP  }
{  NOP  |  NOP  |  NOP  |  NOP  |  NOP  }
{  NOP  |  NOP  |  NOP  |  NOP  |  NOP  }
{  SW R3, R0, 0x40  |  NOP  |  NOP  |  NOP  |  NOP  }
;Mem[0x1E00_0040] = 0x6200_000X, X=0~3
