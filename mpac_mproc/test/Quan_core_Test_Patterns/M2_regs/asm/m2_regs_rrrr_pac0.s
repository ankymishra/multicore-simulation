...
Cluster1_Saving_data_BaseAddr = 0x2501;
  ...
  { lw r1, r0, DMA_SAR7_offset    | lw d0, a0, DMA_SAR5_offset   | nop | nop | nop }
  { lw r2, r0, DMA_DAR7_offset    | lw d1, a0, DMA_DAR5_offset   | nop | nop | nop }
  { lw r3, r0, DMA_SGR7_offset    | lw d2, a0, DMA_SGR5_offset   | nop | nop | nop }
  { lw r4, r0, DMA_DSR7_offset    | lw d3, a0, DMA_DSR5_offset   | nop | nop | nop }
  { lw r5, r0, DMA_CTL7_offset    | lw d4, a0, DMA_CTL5_offset   | nop | nop | nop }
  { lw r6, r0, DMA_LLST7_offset   | lw d5, a0, DMA_LLST5_offset  | nop | nop | nop }
  { lw r7, r0, DMA_PDCTL7_offset  | lw d6, a0, DMA_PDCTL5_offset | nop | nop | nop }
  
  ;===== Write data to Share memory;
  { sw r1, r11, DMA_SAR7_offset   | sw d0, a1, DMA_SAR5_offset   | nop | nop | nop }
  { sw r2, r11, DMA_DAR7_offset   | sw d1, a1, DMA_DAR5_offset   | nop | nop | nop }
  { sw r3, r11, DMA_SGR7_offset   | sw d2, a1, DMA_SGR5_offset   | nop | nop | nop }
  { sw r4, r11, DMA_DSR7_offset   | sw d3, a1, DMA_DSR5_offset   | nop | nop | nop }
  { sw r5, r11, DMA_CTL7_offset   | sw d4, a1, DMA_CTL5_offset   | nop | nop | nop }
  { sw r6, r11, DMA_LLST7_offset  | sw d5, a1, DMA_LLST5_offset  | nop | nop | nop }
  { sw r7, r11, DMA_PDCTL7_offset | sw d6, a1, DMA_PDCTL5_offset | nop | nop | nop }  
