...
Luma_BaseAddr = 0x30051000;
Chroma_BaseAddr = 0x30014000;
M2_Luma_result = 0x2500D500;
M2_Chroma_result = 0x25001600;

Scalar_Saving_data_BaseAddr = 0x2501;
Cluster1_Saving_data_BaseAddr = 0x2502;

  ;==== Test for channel 1,channe 2; ====
  ...
  { lw r1, r0, DMA_SAR1_offset    | lw d0, a0, DMA_SAR2_offset   | nop | nop | nop }
  { lw r2, r0, DMA_DAR1_offset    | lw d1, a0, DMA_DAR2_offset   | nop | nop | nop }
  { lw r3, r0, DMA_SGR1_offset    | lw d2, a0, DMA_SGR2_offset   | nop | nop | nop }
  { lw r4, r0, DMA_DSR1_offset    | lw d3, a0, DMA_DSR2_offset   | nop | nop | nop }
  { lw r5, r0, DMA_CTL1_offset    | lw d4, a0, DMA_CTL2_offset   | nop | nop | nop }
  { lw r6, r0, DMA_LLST1_offset   | lw d5, a0, DMA_LLST2_offset  | nop | nop | nop }
  { lw r7, r0, DMA_PDCTL1_offset  | lw d6, a0, DMA_PDCTL2_offset | nop | nop | nop }
  
  ;===== Write data to Share memory;
  { sw r1, r11, DMA_SAR1_offset   | sw d0, a1, DMA_SAR2_offset   | nop | nop | nop }
  { sw r2, r11, DMA_DAR1_offset   | sw d1, a1, DMA_DAR2_offset   | nop | nop | nop }
  { sw r3, r11, DMA_SGR1_offset   | sw d2, a1, DMA_SGR2_offset   | nop | nop | nop }
  { sw r4, r11, DMA_DSR1_offset   | sw d3, a1, DMA_DSR2_offset   | nop | nop | nop }
  { sw r5, r11, DMA_CTL1_offset   | sw d4, a1, DMA_CTL2_offset   | nop | nop | nop }
  { sw r6, r11, DMA_LLST1_offset  | sw d5, a1, DMA_LLST2_offset  | nop | nop | nop }
  { sw r7, r11, DMA_PDCTL1_offset | sw d6, a1, DMA_PDCTL2_offset | nop | nop | nop }  
