...
Luma_BaseAddr = 0x30048000;
Chroma_BaseAddr = 0x30058000;
M2_Luma_result = 0x2500F800;
M2_Chroma_result = 0x2500C800;
...
d5_value = 0x28713411;
  ...
  { sw r1, r0, DMA_SAR6_offset   | sw d0, a0, DMA_SAR0_offset   | nop | nop | nop }
   ;;DAR                                                                                      
  { movi r2, M2_Luma_result      | movi a1, M2_Chroma_result    | nop | nop | nop }
  { add r2, r2, r8               | add a1, a1, d7               | nop | nop | nop }
  { sw r2, r0, DMA_DAR6_offset   | sw a1, a0, DMA_DAR0_offset   | nop | nop | nop }
  ;;SGR                                                                                      
  { movi r3, r3_value            | movi d1, d1_value            | nop | nop | nop }
  { sw r3, r0, DMA_SGR6_offset   | sw d1, a0, DMA_SGR0_offset   | nop | nop | nop }
  ;;DSR                                                                                      
  { movi r4, r4_value            | movi d2, d2_value            | nop | nop | nop }
  { sw r4, r0, DMA_DSR6_offset   | sw d2, a0, DMA_DSR0_offset   | nop | nop | nop }
  ;;CTL                                                                                      
  { movi r5, r5_value            | movi d3, d3_value            | nop | nop | nop }
  { sw r5, r0, DMA_CTL6_offset   | sw d3, a0, DMA_CTL0_offset   | nop | nop | nop }
  ;;LLST
  { movi r6, r6_value            | movi d4, d4_value            | nop | nop | nop }
  { sw r6, r0, DMA_LLST6_offset  | sw d4, a0, DMA_LLST0_offset  | nop | nop | nop }
  ;;PDCTL
  { movi r7, r7_value            | movi d5, d5_value            | nop | nop | nop }
  { sw r7, r0, DMA_PDCTL6_offset | sw d5, a0, DMA_PDCTL0_offset | nop | nop | nop }
