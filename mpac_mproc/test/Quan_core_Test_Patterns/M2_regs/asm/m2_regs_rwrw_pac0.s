...
Luma_BaseAddr = 0x30078000;
Chroma_BaseAddr = 0x300D1000;
M2_Luma_result = 0x25001800;
M2_Chroma_result = 0x25008A00;

Scalar_Saving_data_BaseAddr = 0x2502;
Cluster1_Saving_data_BaseAddr = 0x2500;

  ;==== Test for channel 3,channe 2; ====
  ...
  { lw r1, r0, DMA_SAR3_offset    | lw d0, a0, DMA_SAR2_offset   | nop | nop | nop }
  { lw r2, r0, DMA_DAR3_offset    | lw d1, a0, DMA_DAR2_offset   | nop | nop | nop }
  { lw r3, r0, DMA_SGR3_offset    | lw d2, a0, DMA_SGR2_offset   | nop | nop | nop }
  { lw r4, r0, DMA_DSR3_offset    | lw d3, a0, DMA_DSR2_offset   | nop | nop | nop }
  { lw r5, r0, DMA_CTL3_offset    | lw d4, a0, DMA_CTL2_offset   | nop | nop | nop }
  { lw r6, r0, DMA_LLST3_offset   | lw d5, a0, DMA_LLST2_offset  | nop | nop | nop }
  { lw r7, r0, DMA_PDCTL3_offset  | lw d6, a0, DMA_PDCTL2_offset | nop | nop | nop }
  
  ;===== Write data to Share memory;
  { sw r1, r11, DMA_SAR3_offset   | sw d0, a1, DMA_SAR2_offset   | nop | nop | nop }
  { sw r2, r11, DMA_DAR3_offset   | sw d1, a1, DMA_DAR2_offset   | nop | nop | nop }
  { sw r3, r11, DMA_SGR3_offset   | sw d2, a1, DMA_SGR2_offset   | nop | nop | nop }
  { sw r4, r11, DMA_DSR3_offset   | sw d3, a1, DMA_DSR2_offset   | nop | nop | nop }
  { sw r5, r11, DMA_CTL3_offset   | sw d4, a1, DMA_CTL2_offset   | nop | nop | nop }
  { sw r6, r11, DMA_LLST3_offset  | sw d5, a1, DMA_LLST2_offset  | nop | nop | nop }
  { sw r7, r11, DMA_PDCTL3_offset | sw d6, a1, DMA_PDCTL2_offset | nop | nop | nop }  
