...
;;
;;DMA
M1_DMA0_start_SAR0 = C0_M1_DMA_base_address + M1_DMASAR0
M1_DMA0_start_DAR0 = C0_M1_DMA_base_address + M1_DMADAR0
M1_DMA0_start_SGR0 = C0_M1_DMA_base_address + M1_DMASGR0
M1_DMA0_start_DSR0 = C0_M1_DMA_base_address + M1_DMADSR0
M1_DMA0_start_CTL0 = C0_M1_DMA_base_address + M1_DMACTL0
M1_DMA0_start_EN0  = C0_M1_DMA_base_address + M1_DMAEN0
...
M1_DMA0_start_STAT = C0_M1_DMA_base_address + M1_DMASTAT
M2_DMA0_start_STAT = M2_DMA_base_address + M2_DMASTAT
;;

;;----------------------------------------
M1_start_address_SubBank0 = C0_M1_base_address + M1_bank7 + M1_SubBank0
M1_start_address_SubBank1 = C0_M1_base_address + M1_bank7 + M1_SubBank1
M1_start_address_SubBank2 = C0_M1_base_address + M1_bank7 + M1_SubBank2
M1_start_address_SubBank3 = C0_M1_base_address + M1_bank7 + M1_SubBank3
M1_start_address_SubBank4 = C0_M1_base_address + M1_bank7 + M1_SubBank4
M1_start_address_SubBank5 = C0_M1_base_address + M1_bank7 + M1_SubBank5
M1_start_address_SubBank6 = C0_M1_base_address + M1_bank7 + M1_SubBank6
M1_start_address_SubBank7 = C0_M1_base_address + M1_bank7 + M1_SubBank7

M1_DMA_start_SAR0         = C0_M1_DMA_base_address + M1_DMASAR0
M1_DMA_start_DAR0         = C0_M1_DMA_base_address + M1_DMADAR0
M1_DMA_start_SGR0         = C0_M1_DMA_base_address + M1_DMASGR0
M1_DMA_start_DSR0         = C0_M1_DMA_base_address + M1_DMADSR0
M1_DMA_start_CTL0         = C0_M1_DMA_base_address + M1_DMACTL0
M1_DMA_start_EN0          = C0_M1_DMA_base_address + M1_DMAEN0

initial_flag = 0x30000000;


EMAU_COREX_M1  = C0_M1_base_address + M1_bank7 + M1_SubBank0
EMAU_COREX_DDR = DDR_base_address   + DDR_bank0

;;set reg
M1_SAR0_DATA = M1_start_address_SubBank1
M1_DAR0_DATA = DDR_start_address_SubBank1
M1_CTL0_DATA = 0x0020000c ; DMA_CTL_DATA, BSZ[31:12], DSEN[9], SGEN[8], Int2Ext[3], Burst[2], TRZ[1:0]
M1_EN0_DATA  = 0x1

M2_dma0_SAR0_DATA = M1_start_address_SubBank5
M2_dma0_DAR0_DATA = M2_start_address_SubBank0
M2_dma0_CTL0_DATA = 0x00200004 ; DMA_CTL_DATA, BSZ[31:12], DSEN[9], SGEN[8], Int2Ext[3], Burst[2], TRZ[1:0]
M2_dma0_EN0_DATA  = 0x1

M2_dma1_SAR0_DATA = M1_start_address_SubBank6
M2_dma1_DAR0_DATA = M2_start_address_SubBank1
M2_dma1_CTL0_DATA = 0x00200004 ; DMA_CTL_DATA, BSZ[31:12], DSEN[9], SGEN[8], Int2Ext[3], Burst[2], TRZ[1:0]
M2_dma1_EN0_DATA  = 0x1


;; =====================================================================================
;; === 1.1 initial memory M2=(0x2500_0000~0x2500_03ff) ,DDR=(0x3001_0000~0x3001_9fff ===
;; === 1.2 initial M1_SubBank0=1 ~ M1_SubBank6=7                                     ===
;; =====================================================================================
INI_NUM_M2   = 256
INI_NUM_DDR  = 1024
INI_NUM_M1   = 128
...
{ MOVIU r1,M2_base_address  | NOP | NOP | NOP | NOP }
{ MOVIU r2,INI_NUM_M2       | NOP | NOP | NOP | NOP }
INI_M2_LOOP:
{ SW r0,r1,4+               | NOP | NOP | NOP | NOP }
{ LBCB r2,INI_M2_LOOP       | NOP | NOP | NOP | NOP }
{ NOP                       | NOP | NOP | NOP | NOP }
{ NOP                       | NOP | NOP | NOP | NOP }
{ NOP                       | NOP | NOP | NOP | NOP }
{ NOP                       | NOP | NOP | NOP | NOP }
...
;; initial DDR = 0
{ MOVIU r0,0                | NOP | NOP | NOP | NOP }
{ MOVIU r1,DDR_base_address | NOP | NOP | NOP | NOP }
{ MOVIU r2,INI_NUM_DDR      | NOP | NOP | NOP | NOP }
INI_DDR_LOOP:
{ SW r0,r1,4+               | NOP | NOP | NOP | NOP }
{ LBCB r2,INI_DDR_LOOP      | NOP | NOP | NOP | NOP }
{ NOP                       | NOP | NOP | NOP | NOP }
{ NOP                       | NOP | NOP | NOP | NOP }
{ NOP                       | NOP | NOP | NOP | NOP }
{ NOP                       | NOP | NOP | NOP | NOP }
...
;;1.2
;; initial M1_SubBank1 = 2
{ MOVIU r0,2                         | NOP | NOP | NOP | NOP }
{ MOVIU r1,M1_start_address_SubBank1 | NOP | NOP | NOP | NOP }
{ MOVIU r2,INI_NUM_M1                | NOP | NOP | NOP | NOP }
INI_M1_SubBank1_LOOP:
{ SW r0,r1,4+                        | NOP | NOP | NOP | NOP }
{ LBCB r2,INI_M1_SubBank1_LOOP       | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
...
;; initial M1_SubBank2 = 3
{ MOVIU r0,3                         | NOP | NOP | NOP | NOP }
{ MOVIU r1,M1_start_address_SubBank2 | NOP | NOP | NOP | NOP }
{ MOVIU r2,INI_NUM_M1                | NOP | NOP | NOP | NOP }
INI_M1_SubBank2_LOOP:
{ SW r0,r1,4+                        | NOP | NOP | NOP | NOP }
{ LBCB r2,INI_M1_SubBank2_LOOP       | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
...
;; initial M1_SubBank3 = 4
{ MOVIU r0,4                         | NOP | NOP | NOP | NOP }
{ MOVIU r1,M1_start_address_SubBank3 | NOP | NOP | NOP | NOP }
{ MOVIU r2,INI_NUM_M1                | NOP | NOP | NOP | NOP }
INI_M1_SubBank3_LOOP:
{ SW r0,r1,4+                        | NOP | NOP | NOP | NOP }
{ LBCB r2,INI_M1_SubBank3_LOOP       | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
...
;; initial M1_SubBank4 = 5
{ MOVIU r0,5                         | NOP | NOP | NOP | NOP }
{ MOVIU r1,M1_start_address_SubBank4 | NOP | NOP | NOP | NOP }
{ MOVIU r2,INI_NUM_M1                | NOP | NOP | NOP | NOP }
INI_M1_SubBank4_LOOP:
{ SW r0,r1,4+                        | NOP | NOP | NOP | NOP }
{ LBCB r2,INI_M1_SubBank4_LOOP       | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
...
;; initial M1_SubBank5 = 6
{ MOVIU r0,6                         | NOP | NOP | NOP | NOP }
{ MOVIU r1,M1_start_address_SubBank5 | NOP | NOP | NOP | NOP }
{ MOVIU r2,INI_NUM_M1                | NOP | NOP | NOP | NOP }
INI_M1_SubBank5_LOOP:
{ SW r0,r1,4+                        | NOP | NOP | NOP | NOP }
{ LBCB r2,INI_M1_SubBank5_LOOP       | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
...
;; initial M1_SubBank6 = 7
{ MOVIU r0,7                         | NOP | NOP | NOP | NOP }
{ MOVIU r1,M1_start_address_SubBank6 | NOP | NOP | NOP | NOP }
{ MOVIU r2,INI_NUM_M1                | NOP | NOP | NOP | NOP }
INI_M1_SubBank6_LOOP:
{ SW r0,r1,4+                        | NOP | NOP | NOP | NOP }
{ LBCB r2,INI_M1_SubBank6_LOOP       | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
{ NOP                                | NOP | NOP | NOP | NOP }
...
{  MOVIU R10, INI_NUM_M1      | NOP | NOP | NOP | NOP }
READ_C0_M1_BANK:
