...
data0_offset   = 0x1200 + bank_starting_address;
data1_offset   = 0x1204 + bank_starting_address;
data2_offset   = 0x1208 + bank_starting_address;
data3_offset   = 0x120C + bank_starting_address;

data4_offset   = 0x1230 + bank_starting_address;
data5_offset   = 0x1234 + bank_starting_address;
data6_offset   = 0x1238 + bank_starting_address;
data7_offset   = 0x123C + bank_starting_address;

data8_offset   = 0x1280 + bank_starting_address;
data9_offset   = 0x1284 + bank_starting_address;
dataA_offset   = 0x1288 + bank_starting_address;
dataB_offset   = 0x128C + bank_starting_address;

dataC_offset   = 0x12A0 + bank_starting_address;
dataD_offset   = 0x12A4 + bank_starting_address;
dataE_offset   = 0x12A8 + bank_starting_address;
dataF_offset   = 0x12AC + bank_starting_address;
...
;====Write data to M2 shared memory by M1 DMA2 ====

;;M2 Base Address
PACDSP2_LDM_BaseAddr = 0x24200000

;;PACDSP CORE0 DMA SETTING
PACDSP2_M2_DMA_Base  = 0x2425C000
...
Luma_BaseAddr      = 0x24200000
Chroma_BaseAddr    = 0x24204000

M1_Luma_result     = M2_Memory_Base + bank_starting_address + 0x1800 
M1_Chroma_result   = M2_Memory_Base + bank_starting_address + 0x1900 

DMA_M1_SR      = 0x24258054
 
 ;======= CLEAR DMA STATUS scalar clr ch0, c1 clr ch1, c2 clr ch2, ch3 ======================

 { movi r0, PACDSP2_M2_DMA_Base | movi a0, PACDSP2_M2_DMA_Base  | movi d0, 0x1        | movi a0, PACDSP2_M2_DMA_Base | movi d0, 0x1 }
 ...
 { movi r0, PACDSP2_M2_DMA_Base | movi a0, PACDSP2_M2_DMA_Base  | nop | nop | nop }
 ;;SAR                                                                                      
