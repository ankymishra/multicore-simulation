...
M2_Luma_result     = M2_Memory_Base + bank_starting_address + 0x0A00;
M2_Chroma_result   = M2_Memory_Base + bank_starting_address + 0x0B00;
...
M1_Luma_result     = M2_Memory_Base + bank_starting_address + 0x1a00;  
M1_Chroma_result   = M2_Memory_Base + bank_starting_address + 0x1b00;  
...
data0_offset   = 0x1300 + bank_starting_address;
data1_offset   = 0x1304 + bank_starting_address;
data2_offset   = 0x1308 + bank_starting_address;
data3_offset   = 0x130C + bank_starting_address;

data4_offset   = 0x1330 + bank_starting_address;
data5_offset   = 0x1334 + bank_starting_address;
data6_offset   = 0x1338 + bank_starting_address;
data7_offset   = 0x133C + bank_starting_address;

data8_offset   = 0x1380 + bank_starting_address;
data9_offset   = 0x1384 + bank_starting_address;
dataA_offset   = 0x1388 + bank_starting_address;
dataB_offset   = 0x138C + bank_starting_address;

dataC_offset   = 0x13A0 + bank_starting_address;
dataD_offset   = 0x13A4 + bank_starting_address;
dataE_offset   = 0x13A8 + bank_starting_address;
dataF_offset   = 0x13AC + bank_starting_address;
