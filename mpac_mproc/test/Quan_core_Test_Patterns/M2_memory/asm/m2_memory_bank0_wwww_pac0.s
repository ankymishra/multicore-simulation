...
data0_offset   = 0x1020+ bank_starting_address;
data1_offset   = 0x1024+ bank_starting_address;
data2_offset   = 0x1028+ bank_starting_address;
data3_offset   = 0x102C+ bank_starting_address;

data4_offset   = 0x1080+ bank_starting_address;
data5_offset   = 0x1084+ bank_starting_address;
data6_offset   = 0x1088+ bank_starting_address;
data7_offset   = 0x108C+ bank_starting_address;
		
data8_offset   = 0x10F0+ bank_starting_address;
data9_offset   = 0x10F4+ bank_starting_address;
dataA_offset   = 0x10F8+ bank_starting_address;
dataB_offset   = 0x10FC+ bank_starting_address;

dataC_offset   = 0x10A0+ bank_starting_address;
dataD_offset   = 0x10A4+ bank_starting_address;
dataE_offset   = 0x10A8+ bank_starting_address;
dataF_offset   = 0x10AC+ bank_starting_address;
...
M1_Luma_result     = M2_Memory_Base + bank_starting_address + 0x1400  
M1_Chroma_result   = M2_Memory_Base + bank_starting_address + 0x1500  
