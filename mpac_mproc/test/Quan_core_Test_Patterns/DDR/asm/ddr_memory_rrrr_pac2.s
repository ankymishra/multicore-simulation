;===============================================================================
; Author: Anthony
; Description: Read data from DDR memory by PAC2,M1_DMA2,M2_DMA1;
; Date: 2010/11/
;===============================================================================
...
;;M1 Base Address
PACDSP0_LDM_BaseAddr = 0x24200000;

;;PACDSP CORE0 DMA SETTING
PACDSP0_M1_DMA_Base  = 0x2425C000;
...
Luma_BaseAddr      = 0x30082000;
Chroma_BaseAddr    = 0x30090000;
...
;==== Read DDR shared memory by M2_DMA1;  
...
Chroma_BaseAddr_M2DMA    = 0x30110000; 
M2_Luma_result     = 0x25005000; //not use
M2_Chroma_result   = 0x25006000; 
