;===============================================================================
; Author: Anthony
; Description: Read data from DDR memory by PAC3,M1_DMA3,M2_DMA0;
; Date: 2010/11/25
;===============================================================================
...
;;M1 Base Address
PACDSP0_LDM_BaseAddr = 0x24300000;

;;PACDSP CORE0 DMA SETTING
 PACDSP0_M1_DMA_Base = 0x2435C000;
...
Luma_BaseAddr      = 0x300A2000;
Chroma_BaseAddr    = 0x300B0000;
...
;==== Read DDR memory by M2_DMA0,;  
PACDSP_M2_DMA_Base       = 0x25820000

Luma_BaseAddr_M2DMA      = 0x30022000
Chroma_BaseAddr_M2DMA    = 0x30100000; 
M2_Luma_result     = 0x2500A000;  //not use
M2_Chroma_result   = 0x25004000;
