;===============================================================================
; Author: Anthony
; Description: Write data to DDR memory by PAC3 and M1_DMA3,M2_DMA0.
; Date: 2010/11/25
;===============================================================================
    
;=== Setting M2 for sync. ===
  { MOVI r0, 0x25015000 | NOP | NOP | NOP | NOP }
  { MOVI r1, 0xFFFFFFFE | NOP | NOP | NOP | NOP }
...
;====Write data to DDR memory by M1 DMA3 ====
...
;==Write data to DDR memory by M2_DMA0
...
M1_Luma_result     = DDR_Memory_Base + 0x1a00;
M1_Chroma_result   = DDR_Memory_Base + 0x1b00;
