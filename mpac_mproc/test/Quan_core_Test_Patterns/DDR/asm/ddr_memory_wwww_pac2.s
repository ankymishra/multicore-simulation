;===============================================================================
; Author: Anthony
; Description:Write data to DDR memory by PAC2 and M1_DMA2,M2_DMA1.
; Date: 2010/11/25
;===============================================================================
...
PACDSP1_LDM_BaseAddr = 0x24200000

;;PACDSP CORE0 DMA SETTING
PACDSP1_M1_DMA_Base  = 0x2425C000
...
M1_Luma_result     = DDR_Memory_Base  + 0x1800  ;replace
M1_Chroma_result   = DDR_Memory_Base  + 0x1900  ;replace
...
;==Write data to DDR memory by M2 DMA1
;;PACDSP CORE0 DMA SETTING
PACDSP3_M2_DMA_Base  = 0x25820000;

M2_Luma_BaseAddr     = 0x25003000;
M2_Chroma_BaseAddr   = 0x25005000;

M2_Luma_result       = DDR_Memory_Base + 0x0A00;
M2_Chroma_result     = DDR_Memory_Base + 0x0B00;
