;===============================================================================
; Author: Anthony
; Description: Read data from DDR memory by PAC1,M1_DMA1;
; Date: 2010/11/
;===============================================================================
...
;;M1 Base Address
PACDSP0_LDM_BaseAddr = 0x24100000;

;;PACDSP CORE0 DMA SETTING
 PACDSP0_M1_DMA_Base = 0x2415C000;
...
Luma_BaseAddr      = 0x30062000;
Chroma_BaseAddr    = 0x30070000;
