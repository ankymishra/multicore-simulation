...
Check_Input()
{
  case $1 in
       asm)
            echo -n "Please input the name of an assembly file : "
            read FN
            if [ ! -e $PWD/$FN.s ] ; then
            ...
            ;;
       out)
            echo -n "Please input the name of an executable file : "
            read FN
            ...
            ;;
       bin)
            echo -n "Please input the name of an binary file : "
            read FN
...
do	 	
  case $format in   
	   ...
	   asm2tic)
	            echo "**********************************************"
	            echo "Convert *.s To *.tic.inst, *.tic.c            "
	            echo "**********************************************"
	            Check_Input asm;
	            Gen_OBJ;
	            Gen_OUT;
