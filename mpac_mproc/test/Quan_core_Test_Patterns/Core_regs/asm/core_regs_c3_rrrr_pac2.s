;===============================================================================
; Author: Anthony
; Description: Read data from controlling register of PAC3;
; Date: 2010/11/23
;===============================================================================
...
;Save the local data memory  base address in r1;
  ...
  { NOP | SW d3 ,a0,RSV1_OFFSET | NOP | NOP | NOP }                   
