...
;===== Move 2KB data from DDR to LDM =====  
  ...
  DMA_SHP_ADDR0 = 0x25820094 ;  
  DMA_RES_ADDR0 = 0x25820098 ;  

  DMA_SAR_DATA0 = 0x30000000 ; set DDR as start address 
  DMA_DAR_DATA0 = 0x2500108D ; set DMEM as destination address 
  DMA_SGR_DATA0 = 0x00000000 ; set SGC[31:20]:8, SGO[19:0]:14
  DMA_DSR_DATA0 = 0x02000030 ; set DSC[31:20]:8, DSO[19:0]:14
  DMA_CTL_DATA0 = 0x00000226 ; DMA_CTL_DATA,BSZ[31:20], DSEN[9], SGEN[8], DSHEN[5], SSHEN[4], Int2Ext[3], Burst[2], TRZ[1:0]
  DMA_ENA_DATA0 = 0x00000000 ; active dma
  DMA_CLR_DATA0 = 0x00000000 ; not used 
  DMA_PAD_DATA0 = 0x03031321 ; PAD_NUM2[31:24],PAD_NUM1[23:16],PAD_UNIT2[15:12],PAD_UNIT1[11:8],PAD_DIR2[5],PAD_DIR1[4],PAD_EN[0]
                             ; up or down     ,left or right  ,up or down      ,left or right  ,0:up,1:down,0:left,1:right            
  DMA_SHP_DATA0 = 0x00002020 ; SRC_X[31:24],SRC_Y[23:16],DST_X[15:8],DST_Y[7:0]
  DMA_RES_DATA0 = 0x00000030 ; SRC[31:16], DST[15:0]
  ...
  { MOVI r0, DMA_SHP_ADDR0 | NOP | NOP | NOP | NOP } 
  { MOVI r1, DMA_SHP_DATA0 | NOP | NOP | NOP | NOP }
  { SW r1, r0, 0x0         | NOP | NOP | NOP | NOP }

  { MOVI r0, DMA_RES_ADDR0 | NOP | NOP | NOP | NOP } 
  { MOVI r1, DMA_RES_DATA0 | NOP | NOP | NOP | NOP }
  { SW r1, r0, 0x0         | NOP | NOP | NOP | NOP }
