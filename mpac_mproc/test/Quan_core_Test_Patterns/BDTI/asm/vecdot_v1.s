...
BASE_ADDR = 0x2400
  ...
  {	NOP	|	MOVI.H A3,BASE_ADDR	|	NOP	|	MOVI.H A3,BASE_ADDR	|	NOP	}
	...
	{	SEQI R2,P9,P8,R1,0	|	DLW D0,A2,8+	|	NOP	|	DLW D0,A2,8+	|	NOP	}
	{	SRAI R0,R0,4	|	DLW D2,A3,8+	|	NOP	|	DLW D2,A3,8+	|	NOP	}
...
_LOOP:											
	...
	{	NOP	|	NOP	|	NOP	|	NOP	|	NOP	}
	{	NOP	|	NOP	|	NOP	|	NOP	|	NOP	}
	{	NOP	|	NOP	|	(P8)FMAC.D AC0,D0,D2	|	NOP	|	(P8)FMAC.D AC0,D0,D2	}
...
TestLoop:											
	{	NOP	|	MOVI.L A2,0x10B0	|	NOP	|	NOP	|	NOP	}
	{	NOP	|	SH D0, A2, 0	|	NOP	|	NOP	|	NOP	}
