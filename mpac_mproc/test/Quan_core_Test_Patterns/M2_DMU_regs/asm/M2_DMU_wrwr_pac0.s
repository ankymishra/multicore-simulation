...
M2_Priority_offset           = 0x0000; ;32 bits;
...
;==== Test for M2_Priority,P0_contention_counter,P1_contention_counter; ====
  ...
  ;M2_Priority,P0_contention_counter                                                                                      
  { movi r1, 0x12345678           | movi d0,0xFEDCBA98           | nop | nop | nop }
  { NOP                           | movi d1,0x134132F7           | nop | nop | nop }
  { NOP | NOP | NOP | NOP | NOP }   
  { NOP | NOP | NOP | NOP | NOP }   
  { sw r1, r0, M2_Priority_offset | sw d0, a0, P0_contention_counter_offset  | nop | nop | nop }
  { NOP                           | sw d1, a0, P1_contention_counter_offset  | nop | nop | nop }
