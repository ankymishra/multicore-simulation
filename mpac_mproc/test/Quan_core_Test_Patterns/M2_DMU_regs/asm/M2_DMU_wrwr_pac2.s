...
;==== Test for P4_contention_counter,P5_contention_counter; ====
    
  { movi r0, M2_DMU_Base          | movi a0, M2_DMU_Base         | nop | nop | nop }
  { NOP | NOP | NOP | NOP | NOP } 

  { movi r1, 0x11                 | movi d0,0xFEDCBA98           | nop | nop | nop }
  { NOP                           | movi d1,0x134132F7           | nop | nop | nop }
  { NOP | NOP | NOP | NOP | NOP }   
  { NOP | NOP | NOP | NOP | NOP }   
  { sw r1, r0, P5_contention_counter_offset | sw d0, a0, P4_contention_counter_offset  | nop | nop | nop }
