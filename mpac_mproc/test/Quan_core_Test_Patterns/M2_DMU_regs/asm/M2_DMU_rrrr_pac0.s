...
CORE_Data_Memory_Base = 0x24000000;
...
;==== Test for M2_Priority,P0_contention_counter,P1_contention_counter; ====
  ...
  { lw r1, r0, M2_Priority_offset  | lw d0, a0, P0_contention_counter_offset  | nop | nop | nop }
  { NOP                            | lw d1, a0, P1_contention_counter_offset  | nop | nop | nop }  
  { nop                            | nop                                      | nop | nop | nop } 
  
  { sw r1, r11, M2_Priority_offset | sw d0, a1, P0_contention_counter_offset  | nop | nop | nop }
  { NOP                            | sw d1, a1, P1_contention_counter_offset  | nop | nop | nop }
