...
;==== Test for NoBurstAddr_offset,P4_contention_counter,P5_contention_counter; ====    
  ...
  { lw r1, r0, NoBurstAddr_offset  | lw d0, a0, P4_contention_counter_offset  | nop | nop | nop }
  { NOP                            | lw d1, a0, P5_contention_counter_offset  | nop | nop | nop }  
  { nop                            | nop                                      | nop | nop | nop }
  
  { sw r1, r11, NoBurstAddr_offset | sw d0, a1, P4_contention_counter_offset  | nop | nop | nop }
  { NOP                            | sw d1, a1, P5_contention_counter_offset  | nop | nop | nop }  
