...
int main()
{
  ...
  A(0x25829000); R(0x0000010D,0xFFFFFFFF);
  A(0x25829004); R(0x00000105,0xFFFFFFFF);
  A(0x25829008); R(0x00000007,0xFFFFFFFF);
  A(0x2582900C); R(0x00000032,0xFFFFFFFF);  
  A(0x25829010); R(0x0000007C,0xFFFFFFFF);
  A(0x25829014); R(0x00000102,0xFFFFFFFF);
  A(0x25829018); R(0x00000007,0xFFFFFFFF);
  A(0x2582901C); R(0x00000077,0xFFFFFFFF);  
