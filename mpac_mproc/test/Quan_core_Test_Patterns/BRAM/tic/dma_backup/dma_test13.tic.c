...
int main()
{
  ...
  /* Parameter 0 */
    ...
    A(0x24000004); R(0x09060504,0xFFFFFFFF);
    A(0x24000008); R(0x0D0C0B0A,0xFFFFFFFF);
    A(0x2400000C); R(0x13120F0E,0xFFFFFFFF);
    A(0x24000010); R(0x17161514,0xFFFFFFFF);
    A(0x24000014); R(0x1D1C1B18,0xFFFFFFFF);
    A(0x24000018); R(0x0000001E,0x000000FF);
   
  /* Parameter 1 */
    A(0x24000020); R(0x29282726,0xFFFFFFFF);
    A(0x24000024); R(0x2D2C2B2A,0xFFFFFFFF);
    A(0x24000028); R(0x34333231,0xFFFFFFFF);
    A(0x2400002C); R(0x38373635,0xFFFFFFFF);
    A(0x24000030); R(0x3F3E3D3C,0xFFFFFFFF);
