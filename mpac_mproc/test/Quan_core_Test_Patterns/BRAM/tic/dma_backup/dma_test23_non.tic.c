...
int main()
{
  ...
  A(0x30070030); W(0x00000000,0xFFFFFFFF);
  A(0x30070034); W(0x00000000,0xFFFFFFFF);
  A(0x30070038); W(0x00000000,0xFFFFFFFF);
  A(0x3007003C); W(0x00000000,0x000000FF);
  A(0x30070040); W(0x00000000,0xFFFFFFFF);
  A(0x30070044); W(0x00000000,0xFFFFFFFF);
  A(0x30070048); W(0x00000000,0xFFFFFFFF);
  A(0x3007004C); W(0x00000000,0xFFFFFFFF);
  
  A(0x30070030); R(0x33323130,0xFFFFFFFF);
  A(0x30070034); R(0x37363534,0xFFFFFFFF);
  A(0x30070038); R(0x3b3a3938,0xFFFFFFFF);
  A(0x3007003C); R(0x0000003C,0x000000FF);
