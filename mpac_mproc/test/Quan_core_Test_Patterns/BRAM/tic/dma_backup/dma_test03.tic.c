...
int main()
{
  ...
  /* Parameter 0 */
  A(0x24000000); W(0x00000000,0xFFFFFF00);
  A(0x24000004); W(0x00000000,0x000000FF);
  A(0x24000008); W(0x00000000,0x00000000);
  A(0x2400000C); W(0x00000000,0x00FFFFFF);

  /* Parameter 1 */
  A(0x24000010); W(0x00000000,0xFF000000);
  A(0x24000014); W(0x00000000,0xFFFFFFFF);
  A(0x24000018); W(0x00000000,0x0000FFFF);  
  
  /* Result check */
  /* Parameter 0 */
  A(0x24000000); R(0x03020100,0xFFFFFF00);
  A(0x24000004); R(0x00000009,0x000000FF);
  A(0x24000008); R(0x00000000,0x00000000);
  A(0x2400000C); R(0x00110B0A,0x00FFFFFF);

  /* Parameter 1 */
  A(0x24000010); R(0x21000000,0xFF000000);
  A(0x24000014); R(0x35302B26,0xFFFFFFFF);
  A(0x24000018); R(0x00003F3A,0x0000FFFF);
