...
; para0: BSZ =  5, SC =  0, SI = 0, DC = 0, DI = 0, SAR = ExternalMemAddr70000, DAR = DspDataMemAddr0000, LLST_Addr = xxxx
; para1: BSZ = 15, SC =  7, SI = 2, DC = 0, DI = 0, SAR = ExternalMemAddr70010, DAR = DspDataMemAddr0010, LLST_Addr = xxxx
; para2: BSZ = 20, SC =  7, SI = 4, DC = 0, DI = 0, SAR = ExternalMemAddr70030, DAR = DspDataMemAddr0020, LLST_Addr = xxxx
; para3: BSZ = 30, SC = 12, SI = 3, DC = 0, DI = 0, SAR = ExternalMemAddr70051, DAR = DspDataMemAddr0040, LLST_Addr = xxxx
;**********************************************************************
.data
;16
...
{  SW R4, R3, 4+      |  NOP  |  NOP  |  NOP  |  NOP  }
;CTL
{  MOVI.L R4, 0x5004  |  NOP  |  NOP  |  NOP  |  NOP  }
{  MOVI.H R4, 0x0000  |  NOP  |  NOP  |  NOP  |  NOP  }
{  SW R4, R3, 4+      |  NOP  |  NOP  |  NOP  |  NOP  }
;EN_CH0
{  MOVI.L R4, 0x0001  |  NOP  |  NOP  |  NOP  |  NOP  }
...
{  SW R4, R3, 4+      |  NOP  |  NOP  |  NOP  |  NOP  }
;CTL
{  MOVI.L R4, 0xF104  |  NOP  |  NOP  |  NOP  |  NOP  }
{  MOVI.H R4, 0x0000  |  NOP  |  NOP  |  NOP  |  NOP  }
{  SW R4, R3, 4+      |  NOP  |  NOP  |  NOP  |  NOP  }
;EN
{  MOVI.L R4, 0x0001  |  NOP  |  NOP  |  NOP  |  NOP  }
...
;************************************************************** Parameter2
{  MOVI.L R3, 0x00F0  |  NOP  |  NOP  |  NOP  |  NOP  }
{  MOVI.H R3, DspDMURegister  |  NOP  |  NOP  |  NOP  |  NOP  }
;SAR
...
;************************************************************** Parameter3
{  MOVI.L R3, 0x0130  |  NOP  |  NOP  |  NOP  |  NOP  }
{  MOVI.H R3, DspDMURegister  |  NOP  |  NOP  |  NOP  |  NOP  }
;SAR
{  MOVI.L R4, 0x0051  |  NOP  |  NOP  |  NOP  |  NOP  }
{  MOVI.H R4, ExternalMemAddr7  |  NOP  |  NOP  |  NOP  |  NOP  }
{  SW R4, R3, 4+      |  NOP  |  NOP  |  NOP  |  NOP  }
;DAR
...
{  SW R4, R3, 4+      |  NOP  |  NOP  |  NOP  |  NOP  }
;SGR
{  MOVI.L R4, 0x000F  |  NOP  |  NOP  |  NOP  |  NOP  }
{  MOVI.H R4, 0x00C0  |  NOP  |  NOP  |  NOP  |  NOP  }
{  SW R4, R3, 4+      |  NOP  |  NOP  |  NOP  |  NOP  }
;DSR
{  MOVI.L R4, 0x0000  |  NOP  |  NOP  |  NOP  |  NOP  }
{  MOVI.H R4, 0x0000  |  NOP  |  NOP  |  NOP  |  NOP  }
