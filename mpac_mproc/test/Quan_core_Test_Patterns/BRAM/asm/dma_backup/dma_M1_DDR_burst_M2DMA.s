...
;======================== Move 1KB data from M2 to DDR =========================
  ...
  { MOVI r7, 0x0 | NOP | NOP | NOP | NOP }        
  { MOVI r9, 0x0 | NOP | NOP | NOP | NOP }          
  
chk_M2_sts:    
  { LW r1, r0, 0x0  | NOP | NOP | NOP | NOP }
  { LW r7, r6, 0x2000 | NOP | NOP | NOP | NOP }  
  { LW r9, r8, 0x4000 | NOP | NOP | NOP | NOP }  
  { NOP | NOP | NOP | NOP | NOP }
  { SW r7, r6, 0x2004 | NOP | NOP | NOP | NOP }    
  { SW r9, r8, 0x4004 | NOP | NOP | NOP | NOP }  
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
...
chk_M2_sts1:    
  ...
  { LW r9, r8, 0x4000 | NOP | NOP | NOP | NOP }  
  { NOP | NOP | NOP | NOP | NOP }
  { SW r7, r6, 0x2008 | NOP | NOP | NOP | NOP }    
  { SW r9, r8, 0x4008 | NOP | NOP | NOP | NOP }  
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
  { SEQI r2, p1, p2, r1, 0x22222222 | NOP | NOP | NOP | NOP }     ; (DMA_STATUS == 0) ? 
