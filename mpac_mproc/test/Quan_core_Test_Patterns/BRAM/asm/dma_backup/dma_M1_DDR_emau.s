...
;===== Move 1KB data from PAC0 M1 to DDR =====  
  ...
  { MOVI r3, DDR_BASE | NOP | NOP | NOP | NOP }  
  { MOVI r4, 0x12345678 | NOP | NOP | NOP | NOP }
  { SW r4, r3, 0x1000  | NOP | NOP | NOP | NOP }       
  { MOVI r4, 0x0 | NOP | NOP | NOP | NOP }  
M1_DDR:                                      
  { LW r1, r0, 0x0  | NOP | NOP | NOP | NOP }
  { LW r4, r3, 0x1000  | NOP | NOP | NOP | NOP } 
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
  { SW r4, r3, 0x1004  | NOP | NOP | NOP | NOP }   
...
DDR_M1:    
  ...
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }    
  { SW r4, r3, 0x1008  | NOP | NOP | NOP | NOP }   
  { NOP | NOP | NOP | NOP | NOP }
  { NOP | NOP | NOP | NOP | NOP }
  { SEQI r2, p1, p2, r1, 0x00002222 | NOP | NOP | NOP | NOP }     ; (DMA_STATUS == 0) ? 
