...
;4000780 
;0000 0100 0000 0000 0000 0111 1000 0000
;        4    0    0   0     7    8    0
...
;//Burst 16;
;;SGR                                                                                      
;{ movi r3, 0x08000780          | movi d1, 0x04000780           | nop                 | nop | nop          }
;{ sw r3, r0, DMA_SGR0_offset   | sw d1, a0, DMA_SGR1_offset    | nop                 | nop | nop          }
;4000780 
;0000 1000 0000 0000 0000 0111 1000 0000
;        8    0    0   0     7    8    0
;gather counter ;offset
;0000_1000_0000 ; 0000_0000_0111_1000_0000
;=128              =780H  
;64 bytes = 8 words;    
;//End of burst 16;
...
;Get power(2,10) bytes at one time;
